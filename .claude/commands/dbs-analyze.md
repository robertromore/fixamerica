...
| `coordinated_polarization` | Coordinated Manipulation of Polarized Environment | The information environment is both structurally polarized (people inhabit separate factual realities) AND being actively manipulated through coordinated state operations. This is the worst-case information scenario: a vulnerable population being deliberately exploited. |
...
| `knowledge_institution_politicization` | Knowledge Institution Politicization | Universities, research institutions, or scientific agencies are experiencing political interference that compromises their ability to produce and share evidence-based knowledge. This can range from funding threats and targeted investigations to systematic curriculum mandates that override professional standards. When knowledge institutions are captured, policy becomes untethered from expertise. |
| `local_accountability_degradation` | Local Accountability Degradation | Local government officials are becoming unaccountable to their constituents. This may manifest as captured local courts, suppressed local media, entrenchment through gerrymandering, or state preemption of local democratic authority. When local democracy fails, citizens lose the most accessible avenue for political participation. |
| `party_personalism` | Party Personalism | The governing party has become centered on an individual leader rather than institutional structures, ideological platforms, or shared governance. Personalist parties make democratic erosion harder to reverse because leadership change requires both removing the leader AND rebuilding party institutions. |
| `digital_surveillance_labor` | Labor Organizing Surveillance | Digital surveillance tools are being used to monitor labor organizing activities. This is a sensitive early indicator—targeting worker organizing often precedes broader restrictions on assembly and association rights. |
| `access_justice_degradation` | Access to Justice Degradation | The legal system is becoming inaccessible to disadvantaged populations. Filing fees, court closures, legal aid cuts, and procedural complexity mean that while laws protecting workers, tenants, and consumers technically exist, they cannot practically be enforced by those who need them. The law's "shield" function is withdrawn from the vulnerable. |
| `regulatory_silencing` | Regulatory Silencing of CSOs | Civil society organizations (unions, advocacy groups, non-profits) are being harassed through administrative means—tax audits, permit denials, registration burdens, donor disclosure requirements—rather than direct criminalization. Organizations aren't banned but are made operationally impossible. |
| `media_self_censorship` | Media Self-Censorship | Journalists and media outlets are avoiding topics or softening criticism due to anticipated government reprisal—even without formal censorship. This is the shadow indicator that precedes visible press freedom decline; the chilling effect is achieved without visible repression. |
| `epm_gen` | Gendered Political Exclusion | Women face structural barriers that prevent them from meaningfully influencing political outcomes—even when they can vote and hold office. Female-dominated workforces (87% of care workers are women) may have formal representation but minimal policy influence. Formal rights become decorative when gendered power exclusion is severe enough. |
| `judicial_purge` | Judicial Purge | Judges are being forcibly removed, pressured to resign, or systematically not replaced based on their rulings rather than misconduct. This represents a qualitative shift from "ignoring the courts" to "replacing the courts"—the judicial shield is not just being defied but dismantled. When courts are reconstituted with loyalty-vetted replacements, independent judicial review effectively ends. |
