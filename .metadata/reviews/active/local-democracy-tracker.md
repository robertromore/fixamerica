# Local Democracy Analysis Review Tracker

## Meta

- **Topic:** local-democracy
- **Target:** analysis/political/local-democracy/
- **Created:** 2026-01-11
...
- **Next actor:** codex
- **Next action:** Initial review of local democracy analysis documents
...
- **Status:** planned
- **Action:** review
- **Input:** analysis/political/local-democracy/
- **Output:** (pending)
- **Summary:** (pending)
- **Next:** claude
...
```text
Read the review tracker at .metadata/reviews/active/local-democracy-tracker.md

Your current task is step 01 with status "planned". Review the target documents in analysis/political/local-democracy/ (files 01-overview.md through 11-legislation.md).

Create your review file at .metadata/reviews/llms/codex/local_democracy_review_2026_01_11.md, then update the tracker per the protocol.
