# Voting Rights Analysis Review Tracker

## Meta

- **Topic:** voting-rights
- **Target:** analysis/political/voting-rights/
- **Created:** 2026-01-11
...
- **Next actor:** codex
- **Next action:** Initial review of voting rights analysis documents
...
- **Status:** planned
- **Action:** review
- **Input:** analysis/political/voting-rights/
- **Output:** (pending)
- **Summary:** (pending)
- **Next:** claude
...
```text
Read the review tracker at .metadata/reviews/active/voting-rights-tracker.md

Your current task is step 01 with status "planned". Review the target documents in analysis/political/voting-rights/ (files 01-overview.md through 11-legislation.md).

Create your review file at .metadata/reviews/llms/codex/voting_rights_review_2026_01_11.md, then update the tracker per the protocol.
