# Party Systems Analysis Review Tracker

## Meta

- **Topic:** party-systems
- **Target:** analysis/political/party-systems/
- **Created:** 2026-01-11
...
- **Next actor:** codex
- **Next action:** Initial review of party systems analysis documents
...
- **Status:** planned
- **Action:** review
- **Input:** analysis/political/party-systems/
- **Output:** (pending)
- **Summary:** (pending)
- **Next:** claude
...
```text
Read the review tracker at .metadata/reviews/active/party-systems-tracker.md

Your current task is step 01 with status "planned". Review the target documents in analysis/political/party-systems/ (files 01-overview.md through 11-legislation.md).

Create your review file at .metadata/reviews/llms/codex/party_systems_review_2026_01_11.md, then update the tracker per the protocol.
