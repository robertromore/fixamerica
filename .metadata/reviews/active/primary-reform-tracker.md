# Primary Reform Analysis Review Tracker

## Meta

- **Topic:** primary-reform
- **Target:** analysis/political/primary-reform/
- **Created:** 2026-01-11
...
- **Next actor:** codex
- **Next action:** Initial review of primary reform analysis documents
...
- **Status:** planned
- **Action:** review
- **Input:** analysis/political/primary-reform/
- **Output:** (pending)
- **Summary:** (pending)
- **Next:** claude
...
```text
Read the review tracker at .metadata/reviews/active/primary-reform-tracker.md

Your current task is step 01 with status "planned". Review the target documents in analysis/political/primary-reform/ (files 01-overview.md through 11-legislation.md).

Create your review file at .metadata/reviews/llms/codex/primary_reform_review_2026_01_11.md, then update the tracker per the protocol.
