...
- Federal constitution binding all residents
- Regional autonomy within federal structure

### 1.2 Key Characteristics

| Dimension | Federation Approach |
|-----------|-------------------|
| Sovereignty | Single (merged) |
| Citizenship | Single federal citizenship with regional identity |
| Territory | Unified territory with regional subdivisions |
| Government | Two levels: federal and regional |
| Military | Single federal military |
| Currency | Single federal currency |
| Foreign Policy | Single federal foreign ministry |
...
| Single citizenship | No (dual) | Yes | No |
| Constitutional merger | No | Yes | No |
| Irreversibility | Reversible | Difficult to reverse | Reversible |
...
Federation requires the highest threshold of trust and stability:

| Requirement | Verification |
|-------------|--------------|
| Phase 2 success criteria sustained 20+ years | JSVC certification |
| Demonstrated demand for federation | Survey data: 50%+ support |
| Cross-community leadership support | Formal endorsements |
| Economic convergence indicators met | Economic analysis |
| All MCF institutions fully integrated | Institutional audit |
...
- 60% approval threshold
- 50% community threshold (elevated due to irreversibility)
...
- International organization membership transfer
...
- 24-month minimum drafting period
- Public consultation throughout

---

## 3. Federal Constitutional Requirements

### 3.1 Non-Negotiable Provisions
...
- Regional taxation (within limits)
...
- Cannot block ordinary legislation

---

## 4. Federal Institutional Design
...
- Service charges
- Regional sales tax supplements (limited)
...
- Independent fiscal authority monitors

---

## 6. Security Transition
...
- Complaints to independent body
...
### 7.1 Phase 1: Constitutional Convention (24-36 months)

| Milestone | Target |
|-----------|--------|
| Convention convenes | Month 1 |
| Preliminary principles adopted | Month 6 |
| Draft constitution published | Month 24 |
| Public consultation | Months 24-30 |
| Final text approved | Month 36 |

### 7.2 Phase 2: Ratification (12-18 months)

| Milestone | Target |
|-----------|--------|
| Constitution referendum | Month 40 |
| International recognition process begins | Month 40 |
| UN membership arrangements | Month 48 |
| Treaty succession finalized | Month 52 |

### 7.3 Phase 3: Institutional Transformation (60-120 months)

| Milestone | Target |
|-----------|--------|
| Federal legislature elected | Month 54 |
| Federal executive inaugurated | Month 56 |
| Constitutional Court constituted | Month 60 |
| Military integration begins | Month 60 |
| Full federal operation | Month 84 |
| Military unification complete | Month 150 |

### 7.4 Total Timeline

**Minimum:** 10 years from Phase 3 entry to full federation
**Expected:** 15-20 years
**Maximum:** Open-ended; stability over speed
...
- Defense agreements: special consideration
...
## 9. Guarantor Role in Federation
...
- Intervention authority for serious violations

### 9.2 Phased Withdrawal

| Period | Guarantor Role |
|--------|---------------|
| Years 1-10 | Full monitoring; international judges |
| Years 10-15 | Reduced monitoring; international judges phase out |
| Years 15-20 | Observer status; intervention on request only |
| Years 20+ | Formal withdrawal; diplomatic relationship only |
...
|------|------------|--------|------------|
| Majoritarian capture | Medium | High | Community vetoes, supermajority requirements |
| Security force imbalance | Medium | High | Phased integration, quotas, oversight |
| Economic dislocation | Low | Medium | Transition assistance, equalization |
| Nationalist backlash | Medium | High | Exit options, gradual implementation |
| Institutional failure | Low | High | Guarantor backstop, reversibility provisions |
...
- 5-year cooling-off period after failed dissolution attempt
...
| Previous | Up | Next |
|----------|-----|------|
| [Confederation Path](02-confederation-path.md) | [Phase 3 Overview](00-overview.md) | [Enhanced Dual-State Path](04-enhanced-dual-state-path.md) |
...
- [Institutional Transformation](05-institutional-transformation.md)

### External References

- Belgian federal system (community model)
- Swiss federation (multilingual model)
- Bosnia-Herzegovina (Dayton constitution)
- South African transition (1994)
- German reunification model
