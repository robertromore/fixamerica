...
> To explicitly list and describe the known **gaps, limitations, and residual risks** in the Regional Federal constitutional system.
>
> This document is not a critique of the design. It is a **completeness check**—acknowledging where constitutional structure ends and where human, cultural, or transitional factors take over.

No constitutional system is gapless.
The legitimacy of a design increases when its limits are named.
...
This document catalogs **known gaps**—areas where:

- constitutional structure cannot fully guarantee outcomes,
- risk is reduced but not eliminated,
- or design intentionally stops short to avoid greater harm.

These gaps are:

- explicitly acknowledged,
- bounded where possible,
- and preferable to the silent assumptions of most constitutions.
...
| 16 | III - Under-Specified | Low | High |
| 17 | III - Under-Specified | — | RESOLVED |
| 18 | III - Under-Specified | — | RESOLVED |
| 19 | III - Under-Specified | — | RESOLVED |
...
- rejects electoral legitimacy entirely,
- embraces political violence,
- or abandons constitutional loyalty,

no institutional design can fully compensate.

**Status:**
Unavoidable. Managed only through time-buying and visibility, not prevention.
...
**Risk:**
Information collapse can delegitimize institutions faster than law can respond.
...
- federal executive,
- Congress,
- sufficient regional governments,
- courts,
- and senior security leadership,

institutional redundancy can be overwhelmed.

**Risk:**
Power consolidation becomes possible despite safeguards.

**Status:**
Mitigated by fragmentation and dual legitimacy requirements; not eliminable.

See [Authoritarian Consolidation Scenario](../03-analysis/05-authoritarian-scenario.md) for detailed analysis of this failure mode.
...
- overwhelm de-escalation mechanisms,
- justify emergency powers,
- force centralization by necessity.

**Risk:**
Emergency normalization despite safeguards.

**Status:**
Unpreventable by constitutional design alone.

See [Authoritarian Consolidation Scenario](../03-analysis/05-authoritarian-scenario.md) for analysis of violence-driven consolidation pathways.
...
**Risk:**
Resentment narratives, regional identity hardening, legitimacy strain.

**Status:**
Mitigated by mobility, benefits floor, amendment adaptability; not eliminable.
...
**Risk:**
Implementation fatigue, uneven capacity, bureaucratic erosion.

**Status:**
Accepted tradeoff in exchange for survivability.
...
- creates temporary ambiguity,
- invites elite maneuvering,
- heightens legitimacy contestation.
...
- unequal administrative maturity,
- uneven public trust,
- inconsistent institutional quality.
...
**Risk:**
Underreaction in fast-moving crises.

**Status:**
Explicitly accepted to prevent abuse and irreversible centralization.
...
**Risk:**
Public discomfort with lack of national uniformity.

**Status:**
Intentional; visibility reduces illusion-driven backlash.
...
- are bounded rather than ignored,
- reflect human limits rather than design errors.

Most constitutional failures arise from **unacknowledged assumptions**, not explicit tradeoffs.

This system is credible because it:

- names its limits,
- resists magical thinking,
- and focuses on survivability rather than perfection.

> **A constitution does not need to be gapless.
> It needs to fail honestly, slowly, and visibly.**
...
- [Meta-Level Conclusions](01-conclusions.md)
