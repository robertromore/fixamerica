...
**Status:**
RESOLVED. All four identified problems are covered by existing constitutional provisions: (1) AI governance for government decision-making — Art II §7-A (algorithmic governance transparency with universal application to all governmental algorithmic systems, including open-source requirement, annual NAS audit, bias testing at p<0.05, anti-black-box provision) + Art III §6 (right to human review of algorithmic determinations with prohibited factors, retroactive review, and enforcement); (2) algorithmic accountability in public services — Art II §7-A(l) (universal application extension to all governmental entities using algorithmic systems affecting life, liberty, property, or constitutional rights, with 90% rubber-stamp presumption and private contractor anti-circumvention); (3) digital identity and credential systems — Art III §7 (right to functional identity and digital habeas corpus with 24-hour hearing, provisional credentials, analog redundancy, data portability) + Art II §4(l-s) (infrastructure interoperability mandate including digital credential portability with 5-second verification threshold, NIST floors, and data sovereignty deconfliction via zero-knowledge proofs); (4) emerging technology regulation coordination — Art II §9 (ETRB with 9 members from 4 appointing authorities, provisional federal/regional jurisdiction, anti-haven provision, sunset review). Related resolved gaps: Gap 208 (algorithmic tyranny — Art II §7-A + Art III §6), Gap 209 (digital death — Art III §7), Gap 144 (algorithmic black-box nullification), Gap 213 (cognitive liberty — Art III §8). Remaining statutory elements (Federal AI Accountability Act, digital identity coordination, foundation model reporting) appropriately live in implementing legislation; constitutional framework already authorizes and mandates them. See [Digital and AI Governance Framework](../../proposals/06-security-justice/digital-ai-governance.md) for statutory implementing provisions.
...
**Status:**
RESOLVED. All four gap components are addressed by existing constitutional provisions: nuclear facility governance by Art II §8(b)(ii) (National Security Operations Override explicitly covering "nuclear safety, including waste repositories, research facilities, and power plants necessary for national energy security") and Art II §10(k) (Security Buffer Designation for nuclear facilities); hazardous materials transport by Art II §4 (energy as structured concurrent domain with federal floors) and Art I §11 (Environmental Border Protection prohibiting transboundary hazardous waste disposal); waste siting by Art II §8 (National Necessity certification for waste repositories) and Gap 265 RESOLVED (National Necessity Easement giving federal siting supremacy over Regional zoning); cross-boundary emergency response by Art I §11 (EPA enforcement), Art II §10 (Vital Federal Operations Protection), and Art IV §10 (nuclear facilities as critical national infrastructure). Additional coverage: Art IV §4(h) (Legacy Burden Factor for nuclear decommissioning costs), Art II §4(h)(4) (imminent hazard with Art I §11 cross-reference for transboundary environmental hazards). Five comprehensive implementing statutes exist: [Nuclear and Hazardous Materials Governance Act](../../proposals/05-environment-infrastructure/nuclear-hazardous-materials.md), [Transboundary Environmental Harm Prevention Act](../../proposals/05-environment-infrastructure/transboundary-environmental-protection-act.md), [Host Community Nuclear Waste Protection Act](../../proposals/05-environment-infrastructure/host-community-nuclear-waste-protection-act.md), [Nuclear Waste Trust Fund and Accountability Act](../../proposals/05-environment-infrastructure/nuclear-waste-trust-fund-act.md), and [International Nuclear Waste Treaty Ratification Act](../../proposals/05-environment-infrastructure/international-nuclear-waste-treaty-act.md). Related resolved gaps: Gap 265 (NIMBY Blockade — National Necessity Easement), Gap 182 (Water War Trap — Federal Commons), Gap 67 (Infrastructure Ransom), Gap 83 (Infrastructure Decay), Gap 66 (Regulatory Dumping), Gap 185 (Race to the Bottom).
...
**Description:**
The constitution places Regions between the Federal government and States and enumerates Regional Exclusive Domains, but it did not previously specify enforcement mechanics for Regional supremacy over State law. This created a practical veto: States could block Regional policy through administrative non-compliance even where Regional authority was constitutionally enumerated.

**Severity:** Medium | **Mitigability:** Resolved

**Risk:**

- Regional authority becomes nominal and unenforceable in practice.
- States can nullify Regional policy through administrative delay or refusal to implement.
- Cross-State infrastructure and coordination fail despite Regional constitutional authority.

**Placement Correction:** Original proposal targeted Article III §7(a-w). Article III §7 is occupied (Digital Habeas Corpus / Gap 209) and Article III is "Rights Floors" — wrong topical home. Corrected to Article II §25 (Allocation of Powers), consistent with related resolved gaps (96, 114, 139, 265, 269).

**Status:** **RESOLVED.** Integrated as **Article II, Section 25 (Regional-State Supremacy and Implementation)** in `02-design/constitution/02-powers-and-rights.md`. Resolved 2026-02-05.

The new section operationalizes Article III Section 3(b) with tiered Regional-State supremacy, ARB classification criteria, cooperative implementation plans with ARB review, a default 70/30 funding split with IFC adjudication, an anti-obstruction ladder with cost recovery and State sovereign immunity waiver, a State constitutional challenge procedure in the National Constitutional Court (no State-court stays), subsidiarity review with an anti-centralization presumption, and adversarial fact-finding for classification disputes. It cross-references Exclusive Federal Domains (Article II Section 1(e)(1)), applies Section 4-A filing limits, and preserves National Necessity priority under Article II Section 17.

**Design Decisions:**

| ID | Decision | Choice | Rationale |
|----|----------|--------|-----------|
| D1 | Placement | Article II §25 (standalone) | Scope warrants standalone section; related gaps all in Article II |
| D2 | Federal Exclusive Domains | Replace with cross-reference to §1(e)(1) | Avoids dual-entry maintenance risk |
| D3 | NCC terminology | Keep "National Constitutional Court"; add definition in Art XVIII §3(e) | NCC appears corpus-wide; selective rename creates inconsistency |
| D4 | Gap 96 harmonization | Explicit cross-reference; Full Preemption overrides local autonomy; Cooperative/Concurrent preserve Local Autonomy Floor | Tiered interaction resolves catch-22 |
| D5 | Fiscal methodology | Delegate B/C ratio methodology to IFC | Avoids hard-coding assumptions; IFC publishes methodology |
| D6 | Sovereign immunity | Standalone waiver in §25(o) | Self-contained; extends existing §4(r)(4) pattern |
| D7 | ARB caseload | Defer to existing §4-A provisions | Existing caps, consolidation, hardship exceptions apply via §25(w) |
| D8 | National Necessity conflict | Federal wins with accommodation per §17(d) | Consistent with existing framework; §25(g)(6) |
| D9 | Mediation before direct implementation | No additional mediation | §25(k) already provides 90+90 day runway; adding delays violates Axiom 7 |
| D10 | Bank non-discrimination | Cross-reference Art III §5 and federal civil rights law | Existing protections bind; IFC monitors lending patterns |

**Gaming Vectors Addressed:**

| Vector | Mechanism |
|--------|-----------|
| Administrative Veto | §25(m) "Working On It" prohibition; hard timelines with constructive denial |
| Local Capture | §25(l) State responsibility for local compliance; obstruction attributed to State |
| Unfunded Mandate Defense | §25(j) 70/30 default split; IFC disproportionate burden petitions |
| Constitutional Objection Shield | §25(p)-(r) NCC review; post-ratification strict scrutiny; anti-manipulation |
| Weaponized Classification | §25(w) disputes count under §4-A filing limits and frivolousness penalties |
| Reverse Coercion | §25(t)-(u) subsidiarity review with anti-centralization presumption |
| Eminent Domain Abuse | §25(g)(5) scope limitation; takings beyond certified scope void |
| Federal vs Regional Conflict | §25(g)(6) National Necessity priority with §17(d) accommodation |

See `02-design/constitution/02-powers-and-rights.md` for full text.
...
**Status:**
**RESOLVED.** Article IV, Section 4-F (Treaty Ratification Accountability) added to 03-regional-governance.md. Six subsections: (a) standard ratification with 120-day mandatory consideration timeline and presidential certification (Senate committee backstop at 180 days), deemed rejection for inaction; (b) House proportional override (2/3 seated membership + 60% population dual threshold, non-self-executing for domestic law, one attempt per treaty, 30-day Senate reconsideration); (c) pre-negotiation consultation; (d) Treaty Blockade finding (ARB investigates after 3 consecutive rejections within 4 years including deemed rejections, bright-line minimum specificity standard, reduced 55% population threshold for 2 years, NCC judicial review limited to procedural regularity); (e) transparency and accountability; (f) coordination (treaty withdrawal independent, indigenous treaty exclusion, Section 4-E quorum protections apply, Transition Freeze absolute with continuous 4-year lookback, new President re-certifies). 18 gaming vectors addressed, 27 design decisions documented. Drafted via multi-LLM protocol: v1 → Round 1 review (2 reviewers, 10 findings: 3 convergent + 4 single-reviewer) → v2 → Round 2 review (2 reviewers, 6 findings: 1 complementary + 5 single-reviewer) → v3 (FINAL) → integration.
