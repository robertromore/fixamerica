...
This document catalogs constitutional gaps where the Regional Federal Framework intentionally stops short of detailed specification. Unlike structural vulnerabilities or missing safeguards, these under-specified domains represent deliberate design choices where constitutional silence serves important purposes:

- **Avoiding overreach** into areas where federal prescription would be inappropriate or counterproductive
- **Allowing experimentation** so Regions can develop diverse approaches suited to their populations
- **Preserving flexibility** for future adaptation as circumstances evolve
- **Respecting contested domains** where premature constitutional settlement might undermine legitimacy

For each gap, this document provides the description, associated risks, current status (including any available proposals or resolutions), and residual concerns. Some gaps have been fully resolved through constitutional provisions and implementing proposals; others remain intentionally under-specified with guidance available; still others represent accepted tradeoffs inherent in the system's design.

---

## Gaps 5-8: Core Under-Specified Domains

### Gap 5 — Media and Information Power

**Description:**
The system does not deeply constitutionalize:
...
### Gap 6 — Political Party Evolution

**Description:**
The system shapes party incentives but does not control:
...
**Risk:**
Entrenched regional machines or cartelization.

**Status:**
Left to political evolution; constitutional regulation deemed riskier.
...
## Gaps 16-32: Inter-Regional and Specialized Domains
...
- fiscal arrangements for shared programs,
- accountability mechanisms for joint bodies.

**Risk:**

- Ad hoc arrangements may lack democratic accountability.
- Asymmetric bargaining power between Regions in negotiations.
- Unclear legal status of inter-regional agreements.
...
### Gap 17 — Inter-Regional Infrastructure Coercion (RESOLVED)

**Description:**
Could a Region use control over infrastructure (roads, rail, energy transmission) to blockade or coerce another Region, particularly one whose only viable connection to other Regions passes through the blocking Region?

**Risk (prior to resolution):**

- Economic coercion through infrastructure denial
- Landlocked-style vulnerability for certain Regions
- Escalation of inter-regional disputes into crises

**Resolution:**
[Article I, Section 6](../../02-design/constitution/01-regional-structure.md) (Right of Transit and Non-Blockade) addresses this constitutionally. Implementation details are in the [National Common Market Access Act](../../proposals/03-economy-commerce/national-common-market-access-act.md), which provides:
...
### Gap 18 — Water Rights and Shared Waterways (RESOLVED)

**Description:**
Could a Region use control over water resources (rivers, aquifers, dams) to harm downstream or adjacent Regions through diversion, pollution, or over-appropriation?

**Risk (prior to resolution):**

- Economic coercion through water denial
- Agricultural and municipal water crises in downstream Regions
- Environmental damage crossing Regional boundaries
- Escalation of water disputes into broader inter-Regional conflict

**Resolution:**
[Article I, Section 7](../../02-design/constitution/01-regional-structure.md) (Water Rights and Shared Waterways) addresses this constitutionally. Implementation details are in the [Interstate Water Resources Coordination Act](../../proposals/05-environment-infrastructure/water-resources-coordination-act.md), which provides:
...
### Gap 19 — Freedom of Movement Between Regions (RESOLVED)

**Description:**
Could a Region impose barriers to entry, exit, or transit for residents of other Regions, creating internal borders within the United States?

**Risk (prior to resolution):**

- Internal travel restrictions or documentation requirements
- Discriminatory waiting periods for public services
- Employment or housing discrimination based on Region of origin
...
- Limiting permissible durational residency requirements (30 days voting, 90 days services, 12 months tuition)
- Providing expedited judicial relief (7 days) for movement restrictions
...
### Gap 20 — Mutual Recognition of Legal Status (RESOLVED)

**Description:**
Could a Region refuse to recognize marriages, professional licenses, business registrations, or other legal statuses from other Regions?

**Risk (prior to resolution):**

- Marriages or adoptions invalid upon crossing Regional lines
- Professionals unable to practice in new Regions
- Businesses unable to operate across Regional boundaries
- Legal uncertainty for mobile citizens

**Resolution:**
[Article I, Section 9](../../02-design/constitution/01-regional-structure.md) (Mutual Recognition) addresses this constitutionally. Implementation details for professional credentials are in the [Interstate Professional Licensing Reciprocity Act](../../proposals/04-social-policy-labor/interstate-professional-licensing-act.md), which provides:
...
### Gap 21 — Environmental Border Dumping (RESOLVED)

**Description:**
Could a Region site polluting facilities near its borders to export environmental harms (air pollution, water contamination, hazardous waste) to neighboring Regions?
...
**Resolution:**
[Article I, Section 10](../../02-design/constitution/01-regional-structure.md) (Environmental Border Protection) addresses this constitutionally. Implementation details are in the [Transboundary Environmental Harm Prevention Act](../../proposals/05-environment-infrastructure/transboundary-environmental-protection-act.md), which provides:
...
### Gap 22 — Cross-Regional Law Enforcement Cooperation (RESOLVED)

**Description:**
Could a Region refuse to extradite fugitives, cooperate in investigations, or allow hot pursuit, creating safe havens for criminals?

**Risk (prior to resolution):**

- Fugitives escaping justice by crossing Regional lines
- Investigation stalemates due to non-cooperation
- Confusion during cross-boundary pursuit of fleeing suspects
- Regions strategically refusing extradition for political reasons

**Resolution:**
[Article I, Section 11](../../02-design/constitution/01-regional-structure.md) (Cross-Jurisdictional Law Enforcement Cooperation) addresses this constitutionally. Implementation details are in the [Interstate Law Enforcement Cooperation Act](../../proposals/06-security-justice/interstate-law-enforcement-cooperation-act.md), which provides:
...
**Status:**
**ACCEPTED TRADEOFF** with **GUIDANCE AVAILABLE**. This domain is highly contested and constitutional silence allows regional experimentation. If adopted, the proposed DLRS mechanism (see [DLRS Proposal](../../proposals/01-foundations/dual-legitimacy-rights-floor-statute.md)) could establish floors if dual-legitimacy threshold is met, but reproductive rights are not among the five enumerated floor domains. Freedom of movement ([Article I, Section 8](../../02-design/constitution/00-index.md)) provides some protection for travel.

See [Contested Domains Guidance](../../proposals/01-foundations/contested-domains-guidance.md) for explanation of constitutional silence, existing protections, and paths to resolution.
...
**Status:**
**ACCEPTED TRADEOFF** with **GUIDANCE AVAILABLE**. The constitution establishes rights floors but leaves firearms policy to regional discretion within those floors. If adopted, the proposed DLRS mechanism (see [DLRS Proposal](../../proposals/01-foundations/dual-legitimacy-rights-floor-statute.md)) could theoretically establish labor or safety floors touching firearms in workplaces, but direct gun rights are not among the enumerated floor domains.

See [Contested Domains Guidance](../../proposals/01-foundations/contested-domains-guidance.md) for explanation of constitutional silence, Second Amendment preservation, and coordination mechanisms available.
...
See [Contested Domains Guidance](../../proposals/01-foundations/contested-domains-guidance.md) for explanation of constitutional silence, existing protections through mutual recognition, and voluntary coordination mechanisms.

---

## Navigation

- Previous: [Category II: Implementation Vulnerabilities](02-implementation-vulnerabilities.md)
- Next: [Category IV: Long-Horizon Systemic Risks](04-long-horizon-risks.md)
- Up: [Gaps Index](00-index.md)
- Main: [Identified Gaps Overview](../02-identified-gaps.md)
