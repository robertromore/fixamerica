...
(f) Implementation procedures are established by statute. See the [D.C. Status Determination Act](../../proposals/08-special-jurisdictions/dc-status-determination-act.md) for the proposed implementing legislation.
...
(f) Implementation procedures are established by statute. See the [Territories Status Determination Act](../../proposals/08-special-jurisdictions/territories-status-act.md) for the proposed implementing legislation.
...
### Why Enumerated Powers Supremacy?

The federal government has expanded far beyond original enumerated powers through:

- implied powers doctrine
- commerce clause expansion
- spending power coercion
- emergency powers accumulation

Enumerated powers supremacy:

- restores meaningful federalism
- creates enforceable boundaries
- prevents creeping centralization
- protects Regional and State authority

### Why Floor Presumption?

Without explicit floor presumption, courts may interpret federal law to preempt state protections exceeding federal standards. The floor presumption:

- preserves state/Regional policy experimentation
- prevents preemption arguments from blocking higher standards
- ensures federal law sets minimums, not maximums
- protects policy diversity

### Why Phased Transition?

Immediate implementation of all provisions would:

- overwhelm administrative capacity
- create legal uncertainty
- risk implementation failures
- generate opposition from disrupted institutions

Phased transition:

- allows orderly implementation
- builds capacity before activation
- maintains stability during change
- creates precedent for future amendments

### Why Immediate Provisions?

Some provisions cannot wait:

- **D.C. representation**: Citizens should not be disenfranchised during transition
- **Rights floors**: Fundamental protections cannot be delayed
- **Power expansion prohibition**: Prevents using transition to grab power
- **Amendment process**: Enables correction of implementation problems
- **Mandatory jurisdiction**: Ensures courts can enforce the Constitution
- **Two-key authorization**: Prevents misuse of military during vulnerable transition

### Why Separate Treatment of Non-State Entities?

The current Constitution:

- denies D.C. residents meaningful representation
- leaves territories in constitutional limbo
- undermines tribal sovereignty through inconsistent treatment

Separate treatment ensures:

- full representation for D.C. residents
- clear path to defined status for territories
- reaffirmation and protection of tribal sovereignty
- no entity left in constitutional uncertainty

### Why the "Bridge and Cliff" Integration Mechanism?

Without Section 4, territories and the District could rationally choose to remain indefinitely in at-large status:

- **The Perverse Incentive:** At-large Senators are dedicated exclusively to their constituents' interests, while joining a Region means sharing representation with larger states. A territory like Puerto Rico (3.2M people) might calculate that at-large status gives them *more* effective representation than being absorbed into a Region dominated by larger states.

- **The "Continued Territorial Status" Escape Hatch:** The Territories Status Determination Act (Section 24) explicitly allows indefinite continued territorial status with representation—no Regional integration required.

The "Bridge and Cliff" mechanism solves this through aligned incentives:

**The Bridge (Integration Bonus):**

- Makes territories a *prize* rather than a *burden*—Regions gain +1 Senate seat for 15 years
- Regions compete to court territories rather than avoiding them
- Territories retain dedicated representation during transition period
- Post-bonus guarantee for large territories prevents post-integration dilution

**The Cliff (Integration Timeline):**

- At-large voting rights expire after 5 years if unassigned
- Creates genuine urgency to complete integration
- Delegate status (voice, no vote) is a real demotion without being disenfranchisement
- Fiscal consequences add economic pressure

**The Orphan Safeguard:**

- Prevents Regions from colluding to reject territories and force them into delegate status
- "Fiscal Discrimination" finding allows ordered assignment
- Federal debt assumption removes the "hot potato" dynamic
- Anti-gaming provisions prevent territories from running up debt pre-integration

This mechanism ensures that:

- Both territories and Regions have positive incentives to integrate
...
- [Implementation](07-implementation.md) - Articles XXI-XXII

---

## Document Navigation

- Previous: [Safeguards](05-safeguards.md)
