...
## Articles XXI-XXII: Default Rules, Definitions, and Commentary

*This document contains the implementation and definition provisions of the Regional Federal Constitution, plus the official non-binding commentary.*
...
- [Transition Act](../../05-implementation/02-transition-act.md) - Implementation legislation
...
- Previous: [Supremacy and Transition](06-supremacy.md)
