...
*This document contains the fiscal architecture provisions of the Regional Federal Constitution.*
...
- (6) measure and classify non-human economic output under Section 21, including development of valuation methodologies in coordination with the Emerging Technology Review Board;
...
#### Financial Instrument Recognition and Contagion Prevention

*[Resolves Gap 137 — "Financial Dumping" via Mutual Recognition.]*

(u) **Solvency Certification.**

(1) The Independent Fiscal Council shall conduct annual Systemic Risk Audits of each Region's financial instruments, including Regional Development Bank assets, Regional bonds, and any financial instrument issued by or guaranteed by a Regional government or its instrumentalities. The audit shall assess solvency, asset quality, and systemic risk exposure. In addition to annual audits, the IFC may initiate an interim audit of any Region when objective indicators of material adverse fiscal change are present, including but not limited to: an increase in the Region's debt-to-GDP ratio exceeding five (5) percentage points in any quarter, a downgrade by two or more nationally recognized rating organizations within a six (6) month period, or notification from the Region's auditors of material restatement of financial position. Interim audits shall follow the same standards and procedures as annual audits.

(2) Regions passing the annual or interim audit receive Solvency Certification valid for one (1) fiscal year from the date of certification. The IFC shall publish certification results within sixty (60) days of the audit's completion.

(3) Interstate recognition of Regional financial instruments — including bonds, notes, certificates, and any obligation issued by or guaranteed by a Regional government, Regional Development Bank, or Regional instrumentality — is contingent upon the issuing Region holding current Solvency Certification. This contingency applies notwithstanding the general mutual recognition requirements of Article I-RF, Section 9. Financial instruments issued by a Region without current Solvency Certification are not entitled to mutual recognition and may be refused by any financial institution, pension fund, or governmental entity in any other Region.

(4) Solvency Certification under this subsection does not constitute a federal guarantee of the certified Region's financial instruments. Certification attests to minimum solvency standards, not creditworthiness, and does not alter the market discipline provisions of subsection (s).

(5) Upon lapse or revocation of a Region's Solvency Certification: (A) existing instruments issued during a valid certification period retain their interstate recognition status for ninety (90) days following the date of lapse or revocation; after the ninety-day period, recognition of existing instruments is suspended until the Region obtains new certification; (B) new instruments issued after certification lapse are not entitled to interstate recognition; (C) if the IFC determines that a Region issued a materially disproportionate volume of financial instruments during the ninety (90) days preceding certification lapse — as evidenced by issuance volumes exceeding one hundred fifty percent (150%) of the Region's average quarterly issuance over the preceding two (2) years — the IFC may retroactively de-recognize instruments issued during the spike period; (D) a Region whose Solvency Certification has lapsed or been revoked may petition the IFC for expedited re-certification, which the IFC shall complete within thirty (30) days.

(6) If the IFC fails to complete an annual audit within ninety (90) days of its scheduled commencement, or fails to complete an expedited re-certification within the thirty (30) day period specified in paragraph (5)(D), the Region's existing Solvency Certification is automatically extended pending completion. A Region may petition the Constitutional Court if IFC delay in completing certification appears targeted or discriminatory; the Court may order the IFC to complete the audit within a specified period not to exceed thirty (30) days.

(v) **Asset Quality Floors.**

(1) The Independent Fiscal Council shall establish and publish Asset Quality Floors — minimum standards for financial instruments eligible for interstate mutual recognition. Asset Quality Floors shall include the following constitutionally mandated categories, with specific numerical thresholds set by the IFC: (A) minimum capital adequacy ratios for Regional Development Banks whose instruments are offered for interstate recognition; (B) maximum non-performing loan ratios for loan portfolios underlying recognized instruments; (C) disclosure requirements for underlying assets, including independent valuation and risk assessment; (D) independent credit rating requirements from at least two nationally recognized rating organizations. The IFC may not eliminate any of these categories. Congress may by two-thirds vote of both chambers add categories but may not remove constitutionally mandated categories.

(2) Financial instruments that fail to meet Asset Quality Floors are not subject to mutual recognition under Article I-RF, Section 9 and may be refused by any financial institution, pension fund, or governmental entity in any other Region.

(3) Packaging, restructuring, repackaging, or synthesizing assets to evade Asset Quality Floors is prohibited. This prohibition extends to: synthetic instruments including credit default swaps, collateralized debt obligations, and derivative instruments whose value is derived from Regional financial instruments; instruments routed through special purpose vehicles, shell entities, or private conduit vehicles with Regional government guarantees, backstops, or implicit support; and any other structure whose practical effect is to present non-compliant assets in a form that appears to meet Asset Quality Floors. The IFC may pierce the structure of any financial instrument — including corporate structures of nominally private entities — and evaluate the quality of underlying assets regardless of the instrument's nominal form, guarantee status, or legal characterization. If the IFC determines that an instrument has been structured to evade Asset Quality Floors, the instrument shall be classified as non-compliant and the issuing Region shall be placed on Warning status under subsection (r).

(4) The IFC shall review and update Asset Quality Floors at least every three (3) years to reflect evolving financial practices and systemic risk conditions. Updated floors may not be set below the initial standards; they may be tightened but not loosened except upon a two-thirds vote of the IFC with published findings that loosening is necessary to accommodate legitimate financial innovation without increasing systemic risk.

(5) Asset Quality Floors apply only to instruments offered for interstate recognition. Regions retain full authority to issue and regulate financial instruments within their own borders for intra-Regional markets, subject to the general debt discipline provisions of this Section.

(6) Financial instruments issued by private entities with Regional government guarantees, backstops, credit enhancements, or implicit support — including instruments issued by entities in which a Regional government or its instrumentalities hold a controlling interest or provide a material portion of operating revenue — are subject to the same Asset Quality Floors as direct Regional instruments. The IFC may pierce corporate structures to identify de facto Regional obligations regardless of the issuing entity's nominal private status.

(w) **Contagion Firewall.**

(1) Upon IFC finding that a Region's financial instruments pose systemic risk to other Regions — as evidenced by: (A) failure of Solvency Certification under subsection (u); (B) a pattern of Asset Quality Floor violations under subsection (v); (C) the Region entering Financial Conservatorship under Section 7; or (D) objective indicators of imminent default, as certified by published IFC finding identifying the specific indicators, their factual basis, and the systemic risk they pose to other Regions — automatic contagion prevention measures activate without further action required. Triggers (A) through (C) activate automatically upon the triggering event; trigger (D) requires a published IFC finding.

(2) Upon activation: (A) mutual recognition of the affected Region's new financial instruments is suspended; no new bonds, notes, or obligations issued by or guaranteed by the Region or its instrumentalities are entitled to interstate recognition until the IFC certifies that the systemic risk condition has been resolved; (B) financial institutions holding existing instruments from the affected Region shall disclose their exposure within thirty (30) days to the IFC and to their Regional regulators; (C) cross-Regional financial institutions with exposure to the affected Region's instruments shall be subject to tiered stress-testing requirements: institutions with exposure exceeding three percent (3%) of assets shall disclose their exposure and conduct internal stress tests within sixty (60) days, reporting results to the IFC and their Regional regulators; institutions with exposure exceeding five percent (5%) of assets shall conduct and publish stress tests within sixty (60) days.

(3) The affected Region may not use common market mechanisms, mutual recognition requirements, or interstate commerce provisions to export losses to other Regions. Any transaction designed to shift financial losses arising from the Region's fiscal distress to financial institutions, pension funds, or governmental entities in other Regions is voidable upon petition by the receiving party or by the IFC. This prohibition extends to transactions routed through private conduit vehicles, special purpose vehicles, interstate shell entities, or any other intermediary structure designed to circumvent the loss export prohibition.

(4) The IFC shall coordinate contagion resolution with the objective of containing systemic risk while preserving interstate commerce and essential government functions in the affected Region. The IFC may authorize continued recognition of specific instruments upon finding that the instruments individually meet Asset Quality Floors notwithstanding the Region's general certification failure.

(5) Contagion firewall measures under this subsection supplement the IFC Fiscal Intervention Hierarchy of Section 10. Subsections (u) through (w) establish the standard operating environment for financial instrument recognition applicable to all Regions at all times; Section 10 Stage 3 constitutes the emergency response for Regions already in fiscal distress, imposing enhanced measures including certification suspension, elevated asset quality floors, and escalated contagion firewalls. Where the escalation provisions of Section 10 and the automatic firewalls of this subsection overlap, both apply; the more protective provision governs. Nothing in this subsection limits the IFC's authority to impose enhanced measures under Section 10 Stage 3 or to initiate Financial Conservatorship under Section 7.

(6) **Interaction with Mutual Recognition.** The financial instrument recognition framework of subsections (u) through (w) governs interstate recognition of Regional financial instruments and is independent of the general mutual recognition framework of Article I-RF, Section 9. Section 9's recognition of legal status, professional credentials, and family status is not affected by this subsection. Where a financial instrument could be characterized as a "legal determination" under Section 9(b), the standards of this subsection prevail for purposes of interstate recognition. An explicit carve-out is established in Article I-RF, Section 9(ee).

(7) **Integration with Anti-Extortion Framework.** When contagion firewall measures activate under this subsection, or when the IFC identifies patterns during Solvency Certification audits under subsection (u) suggesting that a Region's financial behavior may be designed to create systemic risk for coercive purposes, the IFC shall assess whether the conditions result from deliberate Regional action within the meaning of Section 7(c)(5)-(6). If the assessment indicates intentional fiscal coercion, the IFC shall initiate the finding process under Section 7(c)(5)-(10) in parallel with contagion containment measures under this subsection. Data and findings from Solvency Certification audits, Asset Quality Floor evaluations, and Contagion Firewall activations are admissible as evidence in Intentional Fiscal Coercion proceedings under Section 7(c).
...
#### Anti-Extortion and Intentional Fiscal Coercion

(c) **Anti-Extortion and Intentional Fiscal Coercion.**
...
(5) **Intentional Fiscal Coercion Finding.** The IFC may issue an Intentional Fiscal Coercion Finding upon determination, by supermajority vote of five (5) of seven (7) members, that a Region has engaged in deliberate financial behavior designed to create or amplify systemic risk for the purpose of extracting federal concessions, policy exemptions, enhanced equalization transfers, or regulatory forbearance. A Finding requires clear and convincing evidence of: (A) deliberate fiscal behavior materially inconsistent with prudent fiscal management, as assessed against the Region's own revenue capacity and historical borrowing patterns; and (B) a nexus between the deliberate behavior and specific demands, conditions, or leverage directed at the federal government or other Regions, whether expressed publicly, communicated privately, or reasonably inferred from the pattern of conduct.

(6) **Indicators of Intentional Coercion.** The following patterns, among others, constitute evidence supporting an Intentional Fiscal Coercion Finding: (A) rapid accumulation of debt or financial obligations disproportionate to the Region's revenue capacity, coinciding with demands on the federal government or other Regions; (B) deliberate failure to collect authorized revenues while simultaneously increasing borrowing and seeking increased equalization transfers; (C) public or private statements by Regional officials conditioning fiscal discipline on federal policy concessions or regulatory exemptions; (D) manipulation of Regional Development Bank lending policies, or direction of state-influenced financial institutions, pension funds, or public-benefit corporations, to increase systemic interconnection with other Regions' financial systems beyond legitimate economic purposes; (E) issuance of financial instruments designed to trigger Contagion Firewall activation under Section 6(w) for coercive purposes rather than legitimate financing needs; (F) deliberate disruption of Solvency Certification processes under Section 6(u), including refusal to cooperate with IFC audits or provision of materially misleading information.

(7) **Coordinated Financial Coercion.** If the IFC determines that two (2) or more Regions have coordinated financial behavior for coercive purposes — as evidenced by simultaneous or sequential escalation of fiscal risk, shared demands on the federal government, or communications establishing coordination — each participating Region is independently subject to an Intentional Fiscal Coercion Finding and the consequences thereof. Coordinated coercion constitutes an aggravating factor that may justify accelerated escalation through the Fiscal Intervention Hierarchy of Section 10.

(8) **Consequences of Finding.** Upon issuance of an Intentional Fiscal Coercion Finding, the IFC shall impose the least-restrictive measure adequate to address the identified coercive behavior before escalating to more severe remedies; Conservatorship under subparagraph (D) shall be reserved for cases where lesser measures have proven or would be inadequate. Available measures include: (A) the IFC may immediately impose any measure available under Section 6(w) (Contagion Firewall), including suspension of interstate recognition of the Region's financial instruments, regardless of whether the Section 6(w) triggers would otherwise be satisfied; (B) the IFC may impose enhanced fiscal reporting requirements, including real-time disclosure of all new borrowing and financial commitments; (C) the Region's equalization transfers may be reduced or suspended for categories related to the coercive behavior, pending cessation of the conduct and compliance with a remediation plan approved by the IFC; reductions shall not exceed the estimated fiscal benefit the Region derived from the coercive conduct, as determined by the IFC; (D) the finding constitutes grounds for immediate Conservatorship under paragraph (3) without further escalation through the Section 10 hierarchy; (E) the IFC shall refer the finding to Congress, which may impose additional consequences by joint resolution.

(9) **Market Manipulation.** A Region that deliberately manipulates its own bond markets, credit ratings, or fiscal signaling to create instability in other Regions' financial systems — without necessarily triggering the debt-to-GDP overage of subsection (b) — is subject to investigation and finding under paragraphs (5) through (8). Coercive behavior that operates below the Conservatorship threshold through market manipulation or fiscal signaling is not exempt from this subsection merely because the Region's debt-to-GDP ratio remains within the limits of subsection (a). The IFC shall maintain ongoing market surveillance capacity, including monitoring of Regional bond yields, credit default swap spreads, and fiscal signaling patterns, sufficient to detect manipulation under this paragraph.

(10) **Due Process.** Before issuing an Intentional Fiscal Coercion Finding: (A) the IFC shall provide the Region with written notice of the proposed finding, including the specific evidence and indicators relied upon, and an opportunity to respond in writing within thirty (30) days; (B) the Region may present evidence that the identified fiscal behavior serves legitimate fiscal management purposes, that the nexus to coercive demands is coincidental, or that changed circumstances explain the conduct; (C) the IFC shall consider the Region's response and issue a reasoned determination; (D) the Finding is subject to judicial review by the Constitutional Court upon petition within thirty (30) days. During judicial review, interim measures under paragraph (8)(A)-(B) remain in effect if the IFC certifies that systemic risk is imminent; equalization reductions under paragraph (8)(C) are stayed pending review; (E) if the Constitutional Court vacates the Finding, the IFC may not reissue a Finding based on substantially the same conduct absent materially new evidence.

(11) **Personal Accountability.** In addition to the personal liability provisions of subsection (d)(4), Regional officials who are named in an Intentional Fiscal Coercion Finding and who are found by the Constitutional Court to have personally directed or substantially participated in the coercive conduct: (A) shall be disqualified from holding any position involving fiscal authority in any Region or the federal government for ten (10) years from the date of the judicial finding; (B) shall be subject to disgorgement of compensation attributable to the period of intentional coercion, upon judicial order; (C) this paragraph does not create criminal liability; criminal referral for fraud or misconduct remains governed by subsection (d)(4) and applicable federal law.

(12) **Counter-Cyclical Safe Harbor.** Nothing in paragraphs (5) through (11) prohibits legitimate counter-cyclical fiscal policy, including deficit spending during economic downturns, emergency borrowing authorized by federal law, or fiscal expansion consistent with established economic stabilization frameworks. A Region's fiscal behavior shall not be deemed coercive under this subsection solely because it increases borrowing during a recession or economic emergency, provided the borrowing is consistent with the Region's historical counter-cyclical patterns and is not accompanied by demands conditioning fiscal discipline on federal concessions.
...
(b) **Fiscal Adequacy Review Board.** The Independent Fiscal Council shall establish a Fiscal Adequacy Review Board ("FARB") consisting of:
...
(p) **Emergency Fiscal Adjustments.** *[Resolves Gap 123 — "Automatic Fiscal Continuation" as Hostage Tool. Subsections (p) through (r) prevent weaponization of the Automatic Continuing Resolution by providing limited emergency adjustment authority, inflation protection for continuation amounts, and a hard floor for essential government functions.]* During any period of automatic appropriation under this Section:

- (1) If the President declares a National Emergency under Article XVII, or if concurrent Regional emergencies have been declared in three (3) or more Regions, the Independent Fiscal Council may certify that automatic continuation levels are inadequate at the federal level to address the emergency. The IFC certification shall assess fiscal inadequacy based on federal appropriation needs, not merely on the existence of emergency declarations;
- (2) Upon certification by supermajority vote (five (5) of seven (7) members), the IFC may authorize Emergency Fiscal Adjustments increasing automatic continuation levels by up to twenty percent (20%) for specific appropriation categories directly related to the certified emergency. The IFC shall publish written findings identifying: (A) the specific appropriation categories requiring adjustment; (B) the factual basis for inadequacy of continuation levels; (C) the amount of each adjustment and its relationship to emergency needs;
- (3) Emergency Fiscal Adjustments take effect immediately upon certification and expire upon the earlier of: (A) termination of the emergency declaration; (B) enactment of regular appropriations for the affected categories; or (C) one hundred eighty (180) days, unless renewed by the IFC under the same supermajority and findings requirements;
- (4) Congress may override any Emergency Fiscal Adjustment by joint resolution enacted within thirty (30) days of the IFC certification. Congressional override authority under this paragraph is unconditional and not subject to judicial review as to its reasoning. If Congress overrides during an active emergency declaration, it shall within forty-five (45) days either: (A) enact appropriations for the affected categories; or (B) adopt a Fiscal Continuity Resolution explaining why continuation levels are adequate notwithstanding the certified emergency. Failure to take either action within forty-five (45) days restores the IFC's authority to reissue an Emergency Fiscal Adjustment on the same factual basis;
- (5) Emergency Fiscal Adjustments may not be used to fund new programs or agencies not authorized prior to the emergency. Adjustments shall be limited to increasing funding levels for existing programs whose prior-year appropriations are demonstrably insufficient to meet emergency demands;
- (6) The IFC shall report to Congress monthly on all active Emergency Fiscal Adjustments, including expenditure data and continued necessity analysis. If the IFC determines that continuation levels have become adequate — whether through changed circumstances, partial appropriation, or emergency abatement — it shall terminate the adjustment without waiting for the 180-day expiration;
- (7) Nothing in this subsection authorizes the IFC to reduce automatic continuation levels below those established by subsections (b) through (d). The IFC's authority under this subsection is limited to upward adjustment during certified emergencies;
- (8) Emergency Fiscal Adjustment funds certified by the IFC under this subsection are subject to the mandatory disbursement timelines and anti-delay protections of subsections (j) through (o). Executive impoundment or delay of IFC-certified emergency funds constitutes a disbursement violation under subsection (j).

(q) **Inflation Indexing for Continuation.** Automatic continuation amounts under subsection (b):

- (1) Shall be calculated using the prior fiscal year's appropriation adjusted by the Consumer Price Index for All Urban Consumers (CPI-U), as published by the Bureau of Labor Statistics, or by a successor index designated by statute. The ninety-eight percent (98%) haircut of subsection (b) shall be applied to the inflation-adjusted amount, not the nominal prior-year amount. The inflation adjustment preserves the real-value incentive of the ninety-eight percent (98%) haircut while preventing nominal-value erosion from functioning as a de facto spending reduction absent any affirmative legislative decision;
- (2) If annual CPI-U exceeds five percent (5%), the IFC shall publish an assessment of real purchasing power erosion for each major appropriation category and transmit it to Congress within thirty (30) days of CPI-U publication;
- (3) Congress may appropriate below inflation-adjusted continuation levels only by affirmative vote of both chambers. Failure to appropriate does not constitute affirmative authorization to reduce spending in real terms;
- (4) This subsection does not affect the CPI-U adjustment for essential functions under subsection (d), which continues to apply at the full prior-year level without the ninety-eight percent (98%) haircut.

(r) **Appropriation Floor for Government Functions.**

- (1) No department or agency of the federal government shall receive automatic continuation funding below seventy-five percent (75%) of its inflation-adjusted prior-year appropriation, regardless of the duration of the automatic appropriation period. When the compounding reduction under subsection (c) would cause any department or agency's funding to fall below this floor, continuation funding shall be maintained at the floor level. This floor constrains only the automatic continuation mechanism and does not reduce pressure on Congress to enact regular appropriations at adequate levels;
- (2) Constitutional Oversight Bodies — including the Independent Fiscal Council, the Allocation Review Board, the National Election Court, the Judicial Conduct Council, the Inspector General system, and the Independent Electoral Commission — shall be treated as essential functions under subsection (d) for purposes of automatic appropriation, regardless of whether Congress has added them to the essential functions list. This designation is self-executing and may not be overridden by statute;
- (3) If automatic appropriation continues for more than twelve (12) consecutive months, the IFC shall certify to Congress a Fiscal Adequacy Assessment identifying: (A) any government function operating below adequate levels due to continuation; (B) specific risks to public safety, constitutional governance, or treaty obligations; (C) recommended appropriation levels for each affected function. Congress shall hold hearings on the Assessment within thirty (30) days of certification;
- (4) The floor established by paragraph (1) may be reduced below seventy-five percent (75%) only by a two-thirds vote of both chambers accompanied by specific findings that the reduction is necessary for fiscal responsibility and will not impair constitutionally mandated functions;
- (5) Nothing in this subsection limits Congress's authority to appropriate at any level through regular legislation. This subsection constrains only the automatic continuation mechanism, not affirmative appropriations decisions.
...
### Section 21. Fiscal Adaptation to Non-Human Economic Output

*Resolves Gap 212 — Post-Labor Crash (Robot Tax Gap). Ensures the fiscal architecture remains viable as economic output shifts from taxable human labor to automated systems.*

(a) **Taxing Authority.** Congress may impose excise taxes and duties on non-human economic output — value generated by automated, algorithmic, or autonomous systems without proportional human labor input. Such taxes are not direct taxes requiring apportionment among the Regions. This power is in addition to existing taxing authority under Section 1 of this Article.

(b) **Fiscal Capacity Modernization.** For purposes of Fiscal Equalization under this Article:

- (1) "Fiscal Capacity" includes non-human economic output, not only human income and consumption;
- (2) non-human economic output shall be attributed to Regions using market-based sourcing consistent with the apportionment methodology under Section 3(r) of this Article: value is attributed to the Region where the good is consumed or the service is delivered;
- (3) the Independent Fiscal Council shall develop and maintain measurement methodologies for non-human economic output, subject to the transparency requirements of Article II, Section 7-A.

(c) **Displacement Mitigation.** Revenue derived from taxation of non-human economic output shall be dedicated to mitigating labor displacement and ensuring social stability during economic transitions. Congress shall determine the specific allocation by statute.

(d) **Anti-Arbitrage.** To prevent erosion of the tax base through automation-specific structuring:

- (1) economic substance, not legal entity location, determines tax attribution;
- (2) artificial structures that shift the nominal source of automated value — including intellectual property holding arrangements, licensing schemes, and intercompany transfers — shall be disregarded for tax purposes;
- (3) consolidated reporting is required for related automated systems operating across Regions;
- (4) Congress shall establish a minimum effective tax rate on non-human economic output; no Region may undercut this floor through incentives or exemptions.

These provisions supplement the anti-haven protections under Section 3(r) and Section 11-A of this Article.

(e) **Technological Neutrality.** This section does not prohibit automation or technological development, require human labor where automation is more efficient, or penalize productivity improvements. The purpose is fiscal neutrality: the tax base shall reflect actual economic output regardless of whether that output is produced by human labor, automated systems, or any combination thereof.

(f) **Border Adjustment.** Congress shall establish a technological border adjustment mechanism imposing equivalent levies on goods and services produced by non-human systems abroad and imported into the United Regions, to prevent offshore arbitrage that would undermine the domestic tax base under this section.

(g) **Institutional Coordination.** The Emerging Technology Review Board (Article II, Section 9) shall classify technologies as generating "non-human economic output" for purposes of this section. The Independent Fiscal Council shall develop valuation methodologies and measurement standards for classified technologies. The ETRB's domain assignment authority under Article II, Section 9 does not limit federal fiscal authority under this section.

(h) **Activation.** The taxing authority under subsection (a) becomes operative when the Independent Fiscal Council certifies that non-human economic output constitutes a material share of gross domestic product or that labor force participation has declined materially from the date of ratification. Congress shall establish the specific thresholds for activation by statute. The fiscal capacity modernization under subsection (b) and measurement infrastructure under subsection (g) take effect immediately upon ratification.

(i) **Constitutional Floor.** The transition from human to automated economic output shall not erode the fiscal capacity of the Union below levels necessary for constitutional functions. If the Independent Fiscal Council determines that the existing tax base is insufficient to fund essential services and equalization obligations, it shall declare a fiscal capacity emergency. Congress shall act within one hundred eighty (180) days to restore adequate revenue. If Congress fails to act within that period, the automatic appropriation provisions of Section 19 of this Article shall apply, supplemented by a temporary surcharge on non-human economic output at a rate determined by the IFC, not to exceed the rate necessary to restore fiscal adequacy.

---

### Section 22. Protection of Cross-Regional Labor Mobility

*Resolves Gap 138 -- The "Double-Taxation" Border Blockade. Consolidates and supersedes Art I §10(hh)-(ii).*
...
(d) **Provisional Credit.** The credit under subsection (b) shall be applied provisionally at the time of tax withholding or estimated payment to ensure neutrality in worker cash flow. No worker may be required to pay the full tax to both Regions and await a refund. The Independent Fiscal Council shall establish uniform procedures for provisional withholding coordination between Regions within two (2) years of ratification; annual true-up shall be provided by implementing legislation. Provisional credits shall be calculated based on the Source Region's actual statutory rate; if a Source Region withholds at a rate exceeding its statutory rate, the excess shall not increase the provisional credit available to the worker in the Residence Region. The IFC may audit withholding rates and require correction of any systematic over-withholding.

#### Scope

(e) **Functional Definition of Covered Tax.** This Section applies to any compulsory levy predicated on the pursuit of labor or the generation of earned income, regardless of statutory label, and regardless of the level of government imposing it. "Covered tax" includes income taxes, payroll taxes, professional privilege fees, occupational licensing premiums, gross receipts taxes on individual earners, and any other assessment whose incidence falls on the worker's earned income, whether imposed by a Region, a State within a Region, or any political subdivision thereof. For purposes of this Section, "earned income" means compensation received for personal services actually rendered, including wages, salaries, professional fees, commissions, tips, bonuses, and the earned-income component of distributive shares from pass-through entities, but excluding passive investment income, capital gains, and rental income.
...
(g) **Multi-Regional Income Apportionment.** Subsections (a) through (c) establish the source-first credit and rate cap for workers earning income in two Regions. When a worker earns income in three or more Regions, the Independent Fiscal Council shall promulgate and maintain uniform rules for apportioning income among those Regions. These rules shall:
...
- (1) A Region that fails to apply credits as directed by the IFC within sixty (60) days of a binding determination shall be subject to graduated enforcement under subsection (j). The sixty-day period runs from the date of the IFC determination; the thirty-day cure period under subsection (j)(1) runs from the date of the subsequent Non-Compliance Finding, which the IFC shall issue promptly upon expiration of the sixty-day compliance period;
...
Fiscal dependence creates political dependence. If Regions rely on federal transfers for basic operations:

- federal government gains coercive leverage
- Regional policy independence becomes illusory
- political accountability becomes confused

Independent taxing authority ensures each level can fund its constitutional responsibilities without permission from other levels.

### Why Prohibit Unfunded Mandates?

Unfunded mandates allow higher levels of government to:

- impose costs on lower levels without political accountability
- claim credit for programs while shifting blame for funding
- effectively expand their power beyond enumerated limits

The prohibition makes the mandating government internalize costs, creating political accountability for its decisions.

### Why Equalization Transfers?

Without equalization, poorer Regions cannot provide basic governmental services:

- courts, elections, emergency services require minimum scale
- extreme inequality undermines national cohesion
- citizens in poor Regions become second-class

Equalization ensures baseline capacity everywhere while preserving fiscal independence for expenditures above the floor.

### Why Formula-Based Rather Than Discretionary?

Discretionary transfers become:

- political patronage tools
- subject to partisan manipulation
- unpredictable for recipient planning

Formula-based transfers create predictability, remove political discretion, and ensure equal treatment of similarly situated Regions.

### Why the Anti-Coercion Rule?

Conditional funding has been used to:

- compel states to adopt federal policies (drinking age, speed limits)
- expand federal authority beyond enumerated powers
- create effective federal control over nominally state functions

The anti-coercion rule prevents conditional funding from becoming a back door to unconstitutional federal expansion.

---

## Implementation Guidance

### Fiscal Equalization Act Requirements

Congress shall enact a Fiscal Equalization Act establishing:

**Formula Components:**

- measure of Regional fiscal capacity (tax base relative to costs)
- measure of Regional fiscal need (population, geography, service costs)
- equalization target (e.g., bring all Regions to median fiscal capacity)

**Process Requirements:**

- annual calculation by Independent Fiscal Council
- automatic appropriation (mandatory spending)
- formula revision only by supermajority vote

**Accountability:**

- annual reporting on transfers and Regional fiscal status
- auditing by Government Accountability Office
- five-year review cycle for formula adequacy

### Default Rule (Article XXI)

If Congress fails to enact the Fiscal Equalization Act within three years of ratification:

- equalization transfers shall be calculated as flat per-capita grants
- baseline level: five percent of federal revenues
- distributed to Regions with below-median fiscal capacity
- rate declines by one percentage point per year beginning in year six
- floor of two percent to incentivize congressional action
...
- [Regional Structure](01-regional-structure.md) - Article I (Small Region provisions)
- [Implementation](07-implementation.md) - Article XXI (default rules)

---

## Document Navigation

- Previous: [Regional Governance](03-regional-governance.md)
- Next: [Safeguards](05-safeguards.md)
