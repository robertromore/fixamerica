...
## Articles II-III: Allocation of Powers and Rights Floors

*This document contains the allocation of governmental powers and rights floor provisions of the Regional Federal Constitution.*
...
### Section 1(f). Federal Enforcement Operational Immunity

*Resolves Gap 135 — Regional "Licensing" of Federal Operations.*

(f) **Federal Enforcement Operational Immunity.**

- (1) **Credential Supremacy.** No Region or State may require any license, permit, certification, registration, insurance, training, or fee — however denominated — as a condition for federal officers, employees, contractors, or consultants authorized by a federal agency to perform duties pursuant to an enumerated federal power, a constitutional rights floor, or the authority of a Constitutional Oversight Body. This immunity extends to ancillary services necessary for the performance of federal duties, including transportation, equipment operation, laboratory analysis, and technical support. Federal credentials shall be deemed sufficient for all operational purposes within any Region. This subsection applies to personnel acting under direct federal authority; it does not extend to state or local officers except when formally deputized by a federal agency for specific federal enforcement operations.
- (2) **Obstruction Identification.** The Allocation Review Board may identify any Regional or State licensing, permitting, or regulatory requirement as "Federal Operation Obstruction" if the requirement: (A) applies uniquely or disproportionately to personnel performing federal enforcement functions; (B) has the practical effect of preventing, delaying, or materially impeding federal enforcement within the Region, regardless of its facial neutrality; or (C) was enacted, amended, or applied in response to anticipated or ongoing federal enforcement activity, as evidenced by legislative history, temporal proximity to federal action, or selective application. These criteria are disjunctive; satisfaction of any one is sufficient. Upon an obstruction identification, the requirement is immediately suspended as applied to federal personnel. The affected Region may petition the Constitutional Court for review within fourteen (14) days; during review, the suspension remains in effect.
- (3) **Non-Obstruction Duty.** No Region shall impede federal enforcement of constitutional rights floors or the operations of Constitutional Oversight Bodies through licensing, permitting, zoning, inspection, technical requirements, equipment standards, or other administrative requirements. Regional officials who knowingly impose administrative barriers to federal enforcement are subject to federal civil liability under the enforcement provisions of Article III, Section 2. Federal agencies may establish field offices, deploy personnel, and conduct authorized operations within any Region without Regional administrative approval, subject to compliance with generally applicable building, fire, and safety codes that are (i) neutral in purpose and effect, (ii) narrowly tailored to legitimate safety objectives, and (iii) not applied to materially impede federal operations or selectively enforced against federal facilities.
- (4) **Pattern Obstruction.** If the ARB identifies two (2) or more instances of Federal Operation Obstruction by a single Region within any five (5) year period, the Region's licensing authority over the affected professional categories is suspended as applied to all federal enforcement operations until the ARB certifies that the Region has adopted structural reforms sufficient to prevent recurrence. During suspension, federal agencies may conduct enforcement operations within the Region without regard to Regional licensing requirements in the affected categories. The Region may petition the Constitutional Court for review of the pattern finding.
- (5) **Limitations.** (A) This subsection protects operational authority; it does not exempt federal personnel from generally applicable criminal law, tort liability, or professional ethics standards unrelated to licensing for enforcement operations. (B) This subsection does not affect the professional credential protections of Article I-RF, Section 14, which operate independently and protect personal professional standing. Operational immunity under this subsection governs the authority to act within a Region; Section 14 governs personal professional standing. Where conduct implicates both operational authority and personal credentials, both provisions apply independently to their respective domains. (C) Nothing in this subsection authorizes federal personnel to exceed the scope of their lawful federal authority.
- (6) **Interaction with Mutual Recognition.** This subsection addresses federal enforcement operations and is independent of the mutual recognition framework of Article I-RF, Section 9, which governs inter-Regional credential portability. Where both frameworks apply, the more protective provision governs.
...
- (ii) The right has been established by constitutional amendment ratified after the effective date of this Section; OR
- (iii) The right has been established through the Dual-Legitimacy Rights-Floor process of Article III, Section 10.
...
### Section 3-B. Sub-Unit Cooperation Protection

*Resolves Gap 139 — State-Level "Abolition" of Cooperating Sub-units.*

(a) **Project Continuity Protection.**

- (1) When a sub-Regional unit — including any municipality, county, township, special district, or other local government entity — enters into a formal coordination agreement for a project within a Regional Exclusive Domain or Cooperative Implementation domain, the unit may register the agreement with the Allocation Review Board. Registration requires: (A) a copy of the executed coordination agreement; (B) identification of the project and the Regional authority under which it is undertaken; (C) identification of the local governmental functions having a direct and proximate nexus to project implementation; and (D) written notice to the State in which the unit is located, provided at least fourteen (14) days before registration.
- (2) **Interim Protection.** Protection under this section attaches upon delivery of written notice to the State under paragraph (1)(D), not upon ARB registration. From the date of notice delivery until ARB registration or denial, the State may not take any action described in subsection (b)(1) with respect to the notified unit. A State action taken against a sub-Regional unit within ninety (90) days before the unit delivers notice under paragraph (1)(D) is presumed retaliatory and subject to review under subsection (b)(4); the State may rebut this presumption by clear and convincing evidence that the action was initiated before the coordination agreement was contemplated.
- (3) Upon registration, the sub-Regional unit's legal existence and the governmental functions identified in the registration as having a direct and proximate nexus to project implementation are protected under this section. Protection does not extend to governmental functions unrelated to the registered project.
- (4) Protection continues until the earliest of: (A) completion of the project; (B) mutual termination of the coordination agreement by the sub-Regional unit and the Region; (C) deregistration by the ARB under subsection (c)(3); or (D) ARB approval of a State restructuring that ensures project continuity under subsection (b)(3).
- (5) Registration is ministerial; the ARB shall register any agreement that meets the requirements of paragraph (1) within thirty (30) days. The ARB may not refuse registration based on the merits of the underlying project or the desirability of the coordination agreement. However, the ARB shall review whether the governmental functions identified under paragraph (1)(C) have a direct and proximate nexus to project implementation and may narrow the scope of protected functions to those satisfying this standard. The State may challenge a registration within ninety (90) days of registration on the ground that the coordination agreement is a sham or that the registration was procured by fraud. The ARB shall rule on such challenges within sixty (60) days.

(b) **Prohibited State Actions.**

- (1) During the protection period, the State in which the protected unit is located may not, without ARB approval: (A) dissolve, merge, or consolidate the protected unit; (B) revoke or materially alter the unit's home rule authority, charter, or enabling statute insofar as the alteration would impair the unit's capacity to perform its obligations under the coordination agreement; (C) transfer functions necessary for project implementation from the protected unit to a State agency or different local entity; (D) impose mandates, conditions, or restrictions that have the practical effect of preventing or materially impeding project implementation, regardless of facial neutrality; or (E) create or expand a parallel governmental entity with overlapping regulatory, permitting, or veto authority over the protected unit's project-related functions, where the practical effect is to nullify or circumvent the protected unit's capacity to implement the coordination agreement.
- (2) State actions that fall within paragraph (1) are suspended as applied to the protected project. The protected unit's legal existence and project-related authority continue notwithstanding any State law, order, or administrative action to the contrary. Suspension under this paragraph does not affect the State action's validity as applied to governmental functions unrelated to the protected project.
- (3) **Legitimate Restructuring.** A State may petition the ARB for approval to restructure a protected unit. The ARB shall grant the petition if the State demonstrates that: (A) the restructuring would have been undertaken regardless of the Regional project, as evidenced by a documented record of the restructuring rationale predating the coordination agreement or arising from circumstances unrelated to Regional cooperation; (B) the successor entity will assume all obligations under the coordination agreement through a binding written commitment filed with the ARB as a condition of approval, with equivalent or superior institutional capacity to perform the protected functions — and where the successor entity lacks equivalent capacity, the State shall provide supplemental resources, personnel, or technical assistance sufficient to ensure equivalent capacity; and (C) the restructuring will not materially impair or delay project implementation. The ARB shall act on restructuring petitions within sixty (60) days. Approval may include conditions ensuring project continuity. The binding successor commitment filed under this paragraph is enforceable by the Region directly against the successor entity and the State.
- (4) The ARB shall determine whether a State action constitutes prohibited interference under paragraph (1). The determination shall be based on the practical effect of the State action, regardless of its stated purpose or facial neutrality. The criteria of paragraph (1)(A)-(E) are disjunctive; satisfaction of any one is sufficient. Temporal proximity between the State action and the coordination agreement or project milestones constitutes evidence of prohibited purpose.

(c) **Successor Liability, Enforcement, and Deregistration.**

- (1) If a State takes action prohibited under subsection (b) without ARB approval, or in violation of conditions imposed by the ARB: (A) any successor entity — including State agencies, newly created districts, or merged entities — assumes all obligations of the dissolved or restructured unit under the coordination agreement, and where the successor entity lacks the institutional capacity to perform the protected functions, the State shall provide the resources, personnel, and technical assistance necessary to ensure equivalent capacity; (B) the Region may enforce the coordination agreement directly against the State; (C) the State is liable for all project delays and additional costs attributable to the prohibited action; and (D) cost recovery shall follow the procedures of Section 4(n) of this Article, including the fifteen percent (15%) administrative surcharge.
- (2) **State Bad Faith Finding.** If the ARB determines that a State has taken prohibited action under subsection (b) on two (2) or more occasions within any five (5) year period — whether involving the same or different sub-Regional units — or that a single prohibited action has impacted two (2) or more registered projects, the ARB may issue a State Bad Faith Finding. Upon issuance: (A) the State's participation in Regional governance advisory bodies is suspended for the duration of the finding; (B) all coordination agreements registered by sub-Regional units within that State receive enhanced protection, requiring a two-thirds (2/3) supermajority of the ARB for approval of any State restructuring petition under subsection (b)(3) for the duration of the finding; (C) the finding is subject to judicial review by the Constitutional Court upon petition within thirty (30) days; and (D) the finding may be lifted when the ARB certifies that the State has adopted structural reforms sufficient to prevent recurrence, including legislation or constitutional amendments protecting local government cooperation with Regional projects. If a second State Bad Faith Finding is issued within ten (10) years of a prior finding, the ARB may recommend reclassification of the affected project domains from Cooperative Implementation to Regional Exclusive Domain under the procedures of Article II-RF, Section 2, removing State implementation discretion entirely.
- (3) **Deregistration.** The ARB may deregister a coordination agreement upon finding that: (A) the project has been abandoned by the Region or the sub-Regional unit; or (B) the sub-Regional unit has materially breached the coordination agreement, provided that the breach was not caused or substantially contributed to by State action prohibited under subsection (b). Before deregistration for breach, the ARB shall provide the sub-Regional unit with written notice specifying the breach and a ninety (90) day cure period. Where the alleged breach results from State interference — including funding reductions, staffing restrictions, or regulatory burdens imposed on the sub-Regional unit — the breach shall be attributed to the State rather than the sub-Regional unit, and the State's action shall be evaluated under subsection (b).
- (4) **Interaction with Local Government Obstruction.** This section addresses State interference with cooperating sub-units and is complementary to Section 4(l), which addresses local refusal to cooperate. Where a State dissolves a cooperating unit and the successor unit ceases cooperation, the State action shall be treated as prohibited interference under subsection (b), and the State remains responsible for project implementation under Section 4(l)(1)-(2). The protections established by this section constitute the Local Autonomy Floor referenced in Section 4(l).

(d) **Transition.**

- (1) Sub-Regional units that have entered into coordination agreements before the ratification of this section may register such agreements under subsection (a) within one hundred eighty (180) days of ratification. Interim protection under subsection (a)(2) applies from the date of notice delivery under the registration process.
- (2) State restructuring actions completed before the ratification of this section are not subject to review under this section, but obligations under coordination agreements that survived such restructuring may be registered and protected prospectively.
...
(a) **Law/Fact Boundary.** For purposes of Section 7(j) and Section 7(k), and for all proceedings before the Allocation Review Board:
...
- (vi) whether federal action constitutes a "legitimate exercise" of an enumerated power, where that determination depends on disputed empirical predicates regarding the action's effects, scope, or reach.

(4) A "pure question of constitutional interpretation" is a question that turns entirely on the meaning, scope, or application of constitutional text without reference to disputed empirical facts.

#### Standard of Review

(b) **De Novo Review for Mixed Questions.** Notwithstanding Section 7(j)(3) and Section 7(k):

(1) Mixed questions of law and fact shall be subject to de novo review by the Supreme Court upon appeal.

(2) The Supreme Court shall independently determine whether a determination constitutes a purely factual determination, a mixed question, or a pure question of constitutional interpretation.

(3) The prohibition on reweighing factual evidence in Section 7(j)(3) applies only to purely factual determinations as defined in subsection (a)(1). The Supreme Court may examine the factual components of a mixed question to the extent necessary to resolve the constitutional question embedded within it.

(4) The finality of factual determinations under Section 7(k) applies only to purely factual determinations; mixed questions remain subject to appellate review regardless of their factual content.

#### ARB Characterization Obligation

(c) **Mandatory Identification.** In every determination:

(1) The ARB shall explicitly identify each finding as either: (i) a purely factual determination, (ii) a mixed question of law and fact, or (iii) a pure question of constitutional interpretation.

(2) For each finding identified as a purely factual determination, the ARB shall state in writing why the finding does not determine a constitutional boundary, power allocation, or scope of governmental authority.

(3) Failure to identify the nature of a finding creates a rebuttable presumption that the finding is a mixed question of law and fact subject to de novo review under subsection (b).

(4) The ARB may not embed constitutionally determinative conclusions within findings labeled as purely factual. A finding that is labeled "purely factual" but whose substance determines a constitutional boundary shall be treated as a mixed question regardless of its label.

(5) The Adversarial Review Office, in its Adversarial Report under Section 7(u), shall include a specific assessment of whether each finding in the determination is properly characterized as to its law/fact nature.

#### Challenge Procedure

(d) **Characterization Challenges.**

(1) Any party to an ARB proceeding may challenge the ARB's characterization of a finding within fourteen (14) days of the later of: (i) the determination's issuance, or (ii) the Adversarial Review Office's issuance of its Adversarial Report under Section 7(v); provided that the challenge window shall open no later than forty-five (45) days after the determination's issuance regardless of whether the ARO has issued its report.

(2) Characterization challenges shall be filed directly with the Supreme Court and resolved on an expedited basis, with decision within thirty (30) days of filing.

(3) If the Supreme Court determines that one or more findings were improperly characterized as "purely factual," all constitutionally determinative findings in the determination shall be subject to de novo review. The Supreme Court may review the entire determination to the extent that improperly characterized findings affected the outcome.

(4) The Supreme Court, not the ARB, is the final arbiter of whether a finding is constitutionally determinative. The ARB's characterization of its own findings is entitled to no deference.

(5) A characterization challenge under this subsection, whether successful or unsuccessful, does not constitute the "one appeal" under Section 7(o). All parties retain the right to appeal the merits of the determination on constitutional interpretation grounds regardless of the outcome of any characterization challenge.

(6) No party that files or succeeds in a characterization challenge shall be subjected to adverse treatment by the ARB in any subsequent proceeding. The ARB may not consider a party's prior characterization challenges when making determinations, assigning priority, or exercising discretion. Alleged violations shall be referred to the Judicial Conduct Board and, if substantiated, constitute grounds for removal for cause under Section 7(e).

#### Anti-Gaming Provisions

(e) **Systematic Mischaracterization.**

(1) A "Characterization Pattern Finding" is established when the Supreme Court reclassifies three (3) or more ARB findings from "purely factual" to "mixed question" within any rolling two-year period.

(2) Upon a Characterization Pattern Finding, the Judicial Conduct Board and the Adversarial Review Office shall be notified. The ARO shall conduct an investigation into whether the pattern reflects systematic evasion of judicial review.

(3) During the twelve (12) months following a Characterization Pattern Finding, all findings by the ARB that are challenged carry a rebuttable presumption of mixed-question status. The ARB bears the burden of demonstrating that a challenged finding is purely factual.

(4) No member of the ARB who participated in a determination containing an improperly characterized finding may participate in the ARB's application of the Supreme Court's interpretation under Section 7(n)(3) for that determination.

(5) An ARB member who engages in a deliberate pattern of mischaracterization, as determined by the Judicial Conduct Board, is subject to removal for cause under Section 7(e).

(6) If recusals under subsection (e)(4) reduce the number of eligible ARB members below quorum for application of the Supreme Court's interpretation under Section 7(n)(3), the Chief Justice shall, within seven (7) days, appoint temporary members from among retired federal and state appellate judges who have never held partisan elected office. The Chief Justice shall select from a standing list maintained by the Judicial Conference for this purpose. Temporary members serve only for the specific application proceeding, have no authority over other ARB matters, and their appointment terminates automatically upon completion of the application.

#### Coordination

(f) **Relationship to Other Provisions.**

(1) This section supplements Section 7(j) through (o). Where Section 7(j) and (k) reference "factual matters" or "factual evidence," those terms refer to purely factual determinations as defined in subsection (a)(1).

(2) The No Factual Remand provision of Section 7(m) does not apply to mixed questions. When the Supreme Court determines that a finding is a mixed question and reverses the ARB's constitutional interpretation, the Court shall specify the correct interpretation under Section 7(n)(2), and the ARB shall apply it to the existing factual record under Section 7(n)(3). Where the existing factual record is insufficient to apply the correct interpretation due to the ARB's prior mischaracterization of one or more findings, the Supreme Court may direct the ARB to make additional purely factual findings limited to the matters necessary for application; this exception does not authorize general factual remand or reopening of the evidentiary record beyond what the mischaracterization made necessary. Additional findings directed under this provision shall be based solely on the existing evidentiary record — no new evidence may be introduced — and shall be completed within thirty (30) days of the Supreme Court's direction.

(3) The Factual Finding Limitation of Section 7-A(g) applies independently. A finding may satisfy Section 7-A(g)'s transparency requirements while still constituting a mixed question subject to this section. The two provisions address distinct vulnerabilities: Section 7-A(g) ensures data and methodological transparency; this section ensures constitutional questions are not hidden within factual packaging.

(4) The de novo review standard established by Section 7(aa)(2) for bias-tainted determinations is independent of and cumulative with the de novo review standard for mixed questions established by this section. A determination may be subject to de novo review under both provisions simultaneously.

(5) The De Novo Review Mandate of Article XIV, Section 9 establishes the general principle that courts decide all questions of law de novo. This section applies that principle specifically to the ARB context, where the general mandate's preservation of "factual deference" (Article XIV, Section 9(c)) would otherwise leave the law/fact boundary undefined for power-allocation determinations.

(6) Nothing in this section alters the Parallel Filing Prevention provisions of Section 7(p)-(q). Characterization challenges under subsection (d) are procedural motions within the appellate process, not parallel filings.
...
(n) **Emergency Utility Priority.**

*Resolves Gap 143 — The "Utility Siege" of Federal Assets. Subsections (n) through (p) prevent Regions from weaponizing declared emergencies to deprioritize federal facilities through "administrative load management" by establishing explicit emergency utility priority, intermediate self-provision authority, and a Utility Siege finding mechanism with category-specific emergency-power suspension.*

(1) During any declared emergency under Article XVII-RF, resource scarcity event, or utility rationing program — however denominated — facilities protected under this section and Section 8 shall receive utility services (water, electricity, natural gas, telecommunications, and waste management) at a priority level no lower than the highest priority assigned to any Regional emergency service in the Region's emergency allocation plan, including hospitals, emergency medical facilities, fire stations, and law enforcement facilities. If the Region has not established a written emergency allocation plan with defined priority levels, federal facilities shall receive priority equal to the highest-priority user category. This priority applies regardless of whether the emergency is declared by the Region, a local government, or a utility provider. Priority encompasses both the quantity and quality of service — including voltage stability, water quality, signal integrity, and waste collection frequency — not merely nominal delivery. Where a protected facility shares a distribution circuit, feeder, or pipeline segment with non-priority users and selective load-shedding or service reduction is technically infeasible, the entire shared infrastructure segment shall be accorded the priority level of the protected facility.

(2) A Region may reduce utility services to federal facilities during a genuine emergency only if: (A) the same proportional reduction — in both quantity and quality of service — is simultaneously applied to all users at or above the emergency-services priority level; (B) the reduction is the minimum necessary to address the emergency; (C) the Region has provided the affected federal agency with written notice of the emergency and the proposed allocation plan at least forty-eight (48) hours before implementation, or as soon as practicable if the emergency precludes advance notice — in which case the Region shall provide written notice within twelve (12) hours of implementation; and (D) notwithstanding the foregoing, if a utility provider certifies in writing that maintaining federal facility priority would cause imminent grid collapse, cascading system failure, or loss of life-safety systems, the provider may implement immediate load-shedding or service reduction affecting federal facilities for the minimum duration necessary to prevent system failure — the provider shall restore priority service within four (4) hours and submit an incident report to the ARB within twenty-four (24) hours documenting the technical justification for the emergency action. Any allocation plan that reduces federal facility service below the level provided to Regional emergency services — whether in quantity, quality, or reliability — is presumptively a violation of this subsection.

(3) The prohibition on deprioritization under this subsection applies to all utility providers operating within the Region, whether public, private, cooperative, or municipal. A Region may not circumvent this subsection by delegating allocation authority to a private utility provider, special district, or emergency management authority. Utility allocation decisions made by any entity pursuant to, in response to, or in coordination with Regional emergency orders, allocation directives, or regulatory guidance are attributable to the Region for purposes of this section.

(4) Upon written notification by the head of the affected federal agency that a federal facility is receiving utility service below the emergency-services priority level, the Region shall restore priority within twenty-four (24) hours, or as soon as technically practicable if physical infrastructure damage or system-wide capacity constraints make restoration within twenty-four hours infeasible — in which case the Region shall provide the federal agency and the ARB with a written explanation of the impediment and a timeline for restoration not to exceed seventy-two (72) hours. Failure to restore priority within the applicable period constitutes a violation of subsection (b)(1) and triggers the enforcement mechanisms of subsection (m). The federal agency may simultaneously invoke the certification process of subsection (c), the self-provision authority of subsection (o), and the interim ARB order mechanism of subsection (p)(2)(F).

(5) No emergency rationing program affecting facilities protected under this section shall continue for more than thirty (30) days without recertification by the ARB that the underlying emergency conditions persist and that the rationing remains the minimum necessary to address the emergency. The Region bears the burden of demonstrating continued necessity. If the ARB does not recertify within five (5) days of the thirty-day expiration, the rationing program as applied to federal facilities is automatically suspended until recertification.

(o) **Federal Self-Provision Authority.**

(1) When the ARB finds that a Region has violated subsection (n), or when the certification and arbitration process of subsections (c) through (e) has not produced adequate accommodation within the ninety (90) day suspension period, federal agencies may establish independent utility infrastructure for facilities protected under this section and Section 8, including: (A) independent water supply (wells, desalination, storage) on federal property; (B) independent power generation (solar, wind, natural gas, nuclear) on federal property, subject to paragraph (2); (C) independent waste management on federal property; (D) direct utility contracts with providers located outside the obstructing Region, including construction of transmission, pipeline, or transportation infrastructure connecting federal property to out-of-Region providers; and (E) telecommunications infrastructure including independent fiber, microwave, and satellite connections, with rights-of-way access for connecting infrastructure without Regional franchise fees or carrier-selection restrictions.

(2) Federal self-provision infrastructure may be constructed on federal property without Regional permitting, zoning, or environmental review, subject to the following: (A) nuclear power generation on federal property shall comply with all applicable Nuclear Regulatory Commission safety standards, and the exemption from Regional permitting does not extend to NRC licensing requirements; (B) water self-provision infrastructure (wells, desalination) on federal property is exempt from Regional water withdrawal permits, discharge permits, and thermal discharge standards that would otherwise prevent or materially delay self-provision, but shall comply with generally applicable federal water quality and environmental standards; and (C) all self-provision infrastructure shall comply with generally applicable federal safety standards. Construction on non-federal land (including easements and rights-of-way) is subject to the National Necessity Easement provisions of Section 17.

(3) The costs of federal self-provision infrastructure shall be recovered from the obstructing Region's equalization transfers under the cost recovery procedures of Section 4(n), including the fifteen percent (15%) administrative surcharge. Cost recovery under this paragraph is in addition to, not in lieu of, any other enforcement consequences under this section.

(4) Self-provision authority under this subsection is an intermediate measure. It does not preclude the President from invoking the emergency authority of subsection (g) if self-provision is insufficient to maintain operations, nor does it require exhaustion of self-provision before invoking subsection (g).

(p) **Utility Siege Finding.**

(1) The ARB may find that a Region is conducting a "Utility Siege" against federal property if: (A) the Region has declared an emergency under Article XVII-RF or invoked utility rationing authority, and has deprioritized federal facilities below the emergency-services priority level established in subsection (n), whether through reduction in quantity, quality, or reliability of service; (B) the Region has failed to maintain or has deliberately degraded utility infrastructure serving federal facilities during a declared emergency, resulting in service levels below those provided to comparable non-federal users — including where the Region has manufactured or prolonged an emergency through deliberate deferral of infrastructure maintenance or capacity investment; or (C) a pattern of utility-related obstruction — including two (2) or more violations of subsection (n) within any five (5) year period, whether during the same or different declared emergencies — demonstrates that the Region is using emergency declarations or scarcity management as a pretext for deprioritizing federal facilities. These criteria are disjunctive; satisfaction of any one is sufficient.

(2) Upon a Utility Siege Finding: (A) all utility services to affected federal facilities shall be immediately restored to the emergency-services priority level, in both quantity and quality; (B) the Region's authority to modify utility allocation to federal facilities in the affected utility category during declared emergencies is suspended for the duration of the finding — during this suspension, any utility allocation decision in the affected category that would reduce service to federal facilities requires prior ARB approval; (C) the Region is liable for all operational costs, project delays, and self-provision expenditures attributable to the siege, with cost recovery following the procedures of Section 4(n) including the fifteen percent (15%) administrative surcharge; (D) the personal liability provisions of subsection (m)(1) apply to Regional officials who directed, authorized, or knowingly failed to prevent the deprioritization; and (E) if the ARB has made two (2) or more Utility Siege Findings against the same Region within any ten (10) year period, the suspension under paragraph (B) extends to all utility categories, not only the affected category. (F) **Interim ARB Order.** Upon receipt of a written complaint from the head of a federal agency alleging a violation of subsection (n), the ARB may issue an interim order within forty-eight (48) hours directing the Region to restore priority service pending full investigation. The interim order remains in effect until the ARB issues a final determination. A Region that fails to comply with an interim order is subject to the enforcement mechanisms of subsection (m).

(3) A Utility Siege Finding is subject to judicial review by the Constitutional Court upon petition by the affected Region within thirty (30) days. During judicial review, the priority restoration of paragraph (2)(A) and any interim order under paragraph (2)(F) remain in effect. The Region bears the burden of demonstrating by clear and convincing evidence that its emergency declaration and allocation decisions served a legitimate emergency management purpose and were not pretextual. The court shall consider: (A) temporal proximity between the emergency declaration and federal-Regional disputes; (B) whether comparable non-federal users received proportionally similar reductions in both quantity and quality; (C) whether the emergency conditions justified the degree of deprioritization imposed on federal facilities; (D) statements or actions by Regional officials indicating that deprioritization was intended to create leverage; and (E) whether the Region took reasonable steps to prevent or mitigate the emergency through infrastructure maintenance and capacity investment.

(4) A Utility Siege Finding may be lifted when the ARB certifies that the Region has: (A) restored utility services to federal facilities at the emergency-services priority level in both quantity and quality; (B) adopted structural reforms ensuring that future emergency allocation plans treat federal facilities at parity with Regional emergency services; and (C) compensated the federal government for all costs attributable to the siege. If the finding has been in effect for more than two (2) years and the Region demonstrates sustained compliance with paragraphs (A) and (B), the ARB shall lift the finding upon satisfaction of paragraph (C).
...
### Section 10. Dual-Legitimacy Rights-Floor Statute

*Resolves Gap 8 — Rights-Floor Content and Enforcement Detail. Establishes a sub-constitutional dual-consent process for setting rights floors within five enumerated domains, requiring both national popular referendum approval and two-thirds Regional ratification. Floors may be raised by standard DLRS dual consent, and lowered only by DLRS with elevated dual consent (sixty percent referendum plus three-fourths Regional ratification), creating a democratic ratchet that protects minimum standards while preserving Regional authority to exceed them and permitting correction of unworkable floors without requiring full constitutional amendment.*

#### Definition and Scope

(a) **Definition.** A Dual-Legitimacy Rights-Floor Statute (DLRS) is a federal law that sets minimum rights or protections within the enumerated floor domains in subsection (h). A DLRS may not set ceilings, preempt higher Regional or State standards, or reallocate powers beyond floors.

(b) **Floor and Ceiling Distinction.** For purposes of this Section:

- (1) A floor establishes a minimum standard that Regions and States must meet or exceed.
- (2) A ceiling restricts the ability of Regions or States to provide greater protections, broader access, or more stringent standards than the DLRS mandates.
- (3) A provision that mandates a specific method, excludes alternatives, or prohibits stricter standards constitutes a ceiling and is beyond DLRS authority, except that a provision mandating a specific method does not constitute a ceiling if Regions or States may employ alternative methods that provide demonstrably equivalent or superior protection of the underlying right, as certified by the Allocation Review Board.
- (4) A provision that establishes minimum access, minimum protections, or minimum procedural safeguards while permitting Regions and States to exceed those minimums constitutes a floor.

#### Initiation and Ratification

(c) **Initiation.** A DLRS may be proposed by:

- (1) a three-fifths vote of the House of Representatives; or
- (2) two-thirds of Regional Legislatures acting jointly.

(d) **Dual Consent.** A DLRS that raises floor standards or establishes new floor standards takes effect only upon:

- (1) approval by a majority of votes cast in a national popular referendum, administered by Regions pursuant to Article VII, Section 1, with results certified by the Independent Election Commission; and
- (2) ratification by two-thirds of Regions.

(e) **Regional Method (Hybrid).** Each Region may ratify by either:

- (1) Regional Legislature; or
- (2) Regional Referendum.

Each Region must fix its chosen method by public law at least 12 months before any DLRS proposal; no method changes may occur during an active ratification window. If a Region has not fixed its ratification method at the time of proposal, ratification shall require approval by the Regional Legislature.

(f) **Ratification Window.** Ratification must occur within two years of proposal. If dual consent is not achieved, the DLRS fails.

(g) **Cooling-Off Period.** A DLRS that fails ratification may not be re-proposed in substantially similar form for 24 months following the close of the failed ratification window.

- (1) The Allocation Review Board shall determine substantial similarity through a public notice-and-comment process.
- (2) Upon receiving a new DLRS proposal, the Board shall publish the proposal and invite public comment for 30 days on whether it is substantially similar to a failed proposal within the cooling-off period.
- (3) The Board shall issue a written determination with findings within 60 days of proposal submission.
- (4) A proposal is substantially similar if it meets any of the following criteria:
    - (i) addresses the same floor domain and establishes floor standards that, for numerical standards, differ by less than 20 percent from the failed proposal's standards;
    - (ii) addresses the same floor domain and establishes floor standards that are functionally equivalent or differ only in minor procedural details without changing the substantive protection provided;
    - (iii) does not address materially different circumstances or evidence but serves the same specific policy objective through materially identical means, regardless of minor variations in numerical standards; or
    - (iv) when assessed in its totality, achieves a net substantive protection materially equivalent to the failed proposal notwithstanding individual variations in specific provisions.
- (5) The Board's determination is subject to de novo judicial review within 30 days of publication.
- (6) If no challenge is filed within 30 days, the determination is final.

#### Enumerated Domains and Substantive Rules

(h) **Enumerated Floor Domains.** DLRS authority is limited to:

- (1) voting access and election process floors;
- (2) due process and basic civil procedure floors;
- (3) anti-discrimination and equal protection floors;
- (4) labor rights and minimum safety floors; and
- (5) public integrity and anti-corruption floors.

Additional domains require constitutional amendment.

(i) **Ratchet.**

- (1) Floors may be raised by DLRS enacted through the dual-consent process of subsection (d).
- (2) Floors may be lowered by DLRS enacted through an elevated dual-consent process requiring: (A) approval by not less than sixty percent (60%) of votes cast in a national popular referendum; and (B) ratification by three-fourths of Regions.
- (3) Floors may not be lowered, suspended, or repealed by ordinary federal legislation, executive order, regulation, or any mechanism other than subsection (i)(2) or constitutional amendment.
- (4) For purposes of this subsection, "lowering" is defined in subsection (ii).

(j) **Judicial Review.** Courts may review DLRS for:

- (1) procedural compliance with this Section;
- (2) domain scope — whether the DLRS falls within an enumerated floor domain;
- (3) single-subject compliance under subsection (k);
- (4) ceiling conversion — whether any provision constitutes a ceiling under subsection (b); and
- (5) conflict with other constitutional provisions.

All DLRS challenges are subject to mandatory jurisdiction and time-bound review as defined in Article XIV.

(k) **Single Subject.** Each DLRS shall address one floor domain only. A DLRS that addresses multiple domains is void in its entirety.

(l) **Regional Ratification Duty.** Each Region shall conduct its ratification process within 18 months of proposal.

- (1) If a Region fails to complete ratification within this period, the Region is deemed to have abstained.
- (2) Abstention counts neither for nor against the ratification threshold; the threshold is calculated based on Regions that have ratified or rejected.
- (3) A DLRS achieves regional ratification only if ratified by the required proportion of participating Regions and by at least a majority of all Regions. This absolute majority requirement may not be circumvented by abstention.
- (4) If fewer than five Regions have ratified or rejected by the 18-month deadline, the ratification window is extended by 6 months.
- (5) The Independent Election Commission shall publish monthly compliance reports on regional ratification progress beginning 6 months after proposal.

(m) **Emergency Non-Suspension.** Rights floors established by DLRS may not be suspended, waived, or diminished during any emergency declared under Article XVII.

- (1) Any emergency measure that conflicts with a DLRS floor is void to the extent of the conflict.
- (2) This prohibition applies regardless of the nature, scope, or duration of the emergency.
- (3) Courts shall have mandatory jurisdiction to hear claims that emergency measures violate DLRS floors, with expedited review as provided in Article XIV.

(n) **DLRS Conflicts.** Where two or more DLRS provisions conflict:

- (1) the provision that provides greater protection to the individual prevails;
- (2) if relative protection is indeterminate, the more recently ratified DLRS prevails;
- (3) courts shall construe DLRS provisions to harmonize where possible before finding conflict;
- (4) a finding of conflict does not invalidate either DLRS; it determines which provision governs in the specific circumstance.

(o) **Pre-Ratification Review.**

- (1) No court may enjoin or invalidate a DLRS proposal before dual consent is achieved, except as provided in paragraph (5).
- (2) Pre-ratification challenges to DLRS proposals are not justiciable, except as provided in paragraph (5).
- (3) Challenges to DLRS validity may be brought only after certification of dual consent and only within 180 days of the effective date.
- (4) A DLRS that has been in effect for more than 180 days without successful challenge is presumptively valid; subsequent challenges must demonstrate clear constitutional violation.
- (5) Notwithstanding paragraphs (1) and (2), a court may enjoin a DLRS proposal before dual consent if the proposal facially and indisputably falls outside the enumerated floor domains of subsection (h). Such challenges must be filed within 30 days of proposal and resolved within 60 days.
- (6) For purposes of this subsection, the effective date of a DLRS is the date on which the Independent Election Commission certifies dual consent under subsection (p)(5), unless the DLRS itself specifies a later effective date, in which case the later date governs.

(p) **Timing of Dual Consent.**

- (1) The national referendum and regional ratification may proceed concurrently or sequentially within the ratification window.
- (2) Neither form of consent is contingent on the other being completed first.
- (3) If one form of consent is achieved before the other, the achieved consent remains valid for the duration of the ratification window.
- (4) Certification of dual consent occurs when both requirements have been met, regardless of sequence.
- (5) The Independent Election Commission shall certify dual consent within 14 days of the later of the two consent events.

(q) **Proposal Limits.**

- (1) No more than three DLRS proposals may be placed on a national ballot in any 12-month period.
- (2) If more than three proposals are pending, the Independent Election Commission shall schedule them for successive referendum dates in order of proposal date.
- (3) This limitation does not extend the ratification window for delayed proposals; proposals that cannot be scheduled within their ratification window fail.
- (4) Congress may by two-thirds vote waive this limitation for a specific proposal upon finding exceptional circumstances.

#### Applicability, Standing, and Transition

(r) **Transition Period.**

- (1) No DLRS may be proposed until Phase V of the Constitutional Transition Act is complete and full activation has occurred.
- (2) During Phases III and IV, Congress may prepare draft DLRS for consideration upon full activation; such drafts have no legal effect until formally proposed.
- (3) The first DLRS proposals may be submitted beginning 90 days after Phase V completion.
- (4) Draft DLRS prepared during transition are not subject to the cooling-off period provisions of subsection (g).

(s) **Territorial Applicability.**

- (1) DLRS floors apply to the District of Columbia and incorporated territories.
- (2) Unincorporated territories may opt in to DLRS coverage by resolution of their legislature; such opt-in is irrevocable for the duration of the DLRS.
- (3) Tribal nations are not subject to DLRS unless they consent by formal action of their governing body as provided in Article XXIII, Section 11. Consent may be revoked by the same formal process. Partial consent to specific DLRS provisions is permitted as provided in Article XXIII, Section 11(a)(3). A Tribal Nation that partially consents is subject to the consented provisions for purposes of standing, enforcement, and compliance under this Section.
- (4) For purposes of regional ratification, territories assigned to Regions under Article XX participate through their Region's ratification process.
- (5) Nothing in this Section diminishes tribal sovereignty or self-governance rights.

(t) **Standing.**

- (1) Any person subject to a DLRS floor standard has standing to challenge its validity or seek its enforcement.
- (2) Any Region or State has standing to challenge a DLRS on procedural or domain-scope grounds.
- (3) Standing is not limited by the political question doctrine; DLRS challenges are justiciable.
- (4) Organizational standing is permitted where members would have individual standing.
- (5) The responsible federal agency has standing to enforce DLRS against non-compliant Regions or States.

#### Interpretation and Amendment

(u) **Interpretation.**

- (1) DLRS provisions shall be construed liberally to effectuate their protective purpose.
- (2) Ambiguities shall be resolved in favor of greater protection for individuals.
- (3) DLRS floors establish minimums, not optimal standards; higher standards are presumptively valid.
- (4) Legislative history and pre-referendum impact statements may be consulted but are not dispositive.
- (5) Subsequent DLRS in the same domain shall be construed to supplement, not replace, prior DLRS unless explicit repeal language is included.

(v) **Amendment and Replacement.**

- (1) A DLRS may be amended to raise specific floor standards without replacing the entire statute; such amendments require full dual consent under subsection (d).
- (2) A DLRS may be replaced by a subsequent DLRS in the same domain; the replacement must explicitly identify provisions superseded. The Independent Election Commission shall publish a certified side-by-side comparison of the replacement and superseded DLRS during the pre-referendum comment period.
- (3) A replacement DLRS may not add sunset provisions under subsection (w) to any floor standard that was not already subject to sunset in the DLRS it supersedes. Floor standards carried forward from a prior DLRS retain their non-sunset status.
- (4) Implicit repeal is disfavored; courts shall harmonize overlapping DLRS where possible under subsection (n).
- (5) Technical corrections may be made by concurrent resolution of Congress and two-thirds of Regional Legislatures without referendum, subject to certification by the Independent Election Commission that the correction does not alter substantive floor standards. A technical correction may change only typographical errors, grammatical errors, internal cross-reference numbering, and formatting. A technical correction may not change any word or number that appears in a substantive floor standard, compliance deadline, threshold, penalty, or definition.
- (6) Proposed technical corrections shall be published for 60-day public comment before the concurrent resolution takes effect. Any person or Region may file an objection, which triggers automatic judicial review within 30 days.

(w) **Sunset Limitations.**

- (1) Substantive rights floors established by DLRS may not be subject to sunset provisions.
- (2) Sunset provisions are permitted only for:
    - (i) specific funding appropriations attached to the DLRS;
    - (ii) temporary administrative bodies created to implement the DLRS; or
    - (iii) pilot programs explicitly designated as temporary, provided the pilot program does not itself establish a floor standard.
- (3) The expiration of funding or administrative provisions under this subsection does not extinguish the underlying right or floor standard.
- (4) Sunset provisions permitted under paragraph (2) shall not exceed 15 years from effective date.
- (5) Sunset provisions may not be added by technical correction; they must be included in the original DLRS or added by amendment under subsection (v).

(x) **External Standards References.**

- (1) A DLRS may incorporate external standards by reference only if:
    - (i) the external standard is publicly available at no cost or at reasonable cost with public library access;
    - (ii) the reference specifies either a fixed version (static incorporation) or permits updates (dynamic incorporation);
    - (iii) the reference includes a floor fallback if the external standard is discontinued or becomes unavailable.
- (2) Dynamic incorporation of external standards that would lower floors below the highest level previously in effect under the dynamic incorporation is void; the highest previously effective floor level continues in effect.
- (3) The DLRS Registry shall track incorporated external standards and their current versions.
- (4) The responsible federal agency shall notify Congress and Regional Legislatures within 30 days if an incorporated external standard is materially revised or discontinued.

(y) **Regional Boundary Changes.**

- (1) If a Region splits during a DLRS ratification window:
    - (i) the original Region's ratification status applies to successor Regions until they independently act;
    - (ii) successor Regions may independently ratify or reject within 6 months of formal recognition as separate Regions.
- (2) If Regions merge during a DLRS ratification window:
    - (i) if both predecessor Regions ratified, the merged Region is deemed to have ratified;
    - (ii) if neither predecessor Region ratified, the merged Region is deemed not to have ratified;
    - (iii) if ratification status differed, the merged Region must affirmatively act within 6 months of merger.
- (3) Boundary adjustments not affecting Regional identity do not alter ratification status.
- (4) For DLRS already in effect, boundary changes do not affect applicability; DLRS floors apply to all territory within recognized Regions.

(z) **Minority Rights Protection.**

- (1) No DLRS floor standard shall be construed or applied to:
    - (i) diminish existing constitutional protections for discrete and insular minorities;
    - (ii) authorize discrimination prohibited elsewhere in this Constitution;
    - (iii) prevent Regions from providing heightened protections to vulnerable populations.
- (2) Courts reviewing DLRS challenges shall apply heightened scrutiny where a floor standard is alleged to have disparate impact on constitutionally protected groups.
- (3) The pre-referendum impact statement shall include analysis of potential disparate impacts on protected groups.
- (4) If a court finds that a DLRS provision has unjustified disparate impact, it may sever that provision while preserving the remainder of the DLRS.

(aa) **Treaty Obligations.**

- (1) DLRS floor standards shall be construed consistently with binding treaty obligations of the United States where possible.
- (2) Where a treaty establishes a higher standard than a DLRS floor, the treaty standard governs.
- (3) Where a DLRS floor establishes a higher standard than a treaty minimum, the DLRS floor governs domestically.
- (4) Nothing in this Section affects the constitutional status of treaties or the treaty-making powers as provided in this Constitution.
- (5) A DLRS may not be used to circumvent treaty obligations or to effectively withdraw from treaty commitments without following constitutional procedures.

#### Administration and Transparency

(bb) **DLRS Registry.**

- (1) The Independent Election Commission shall maintain a public DLRS Registry containing:
    - (i) all proposed, pending, ratified, and failed DLRS;
    - (ii) full text, ratification history, and effective dates;
    - (iii) indexed standard values and adjustment history;
    - (iv) compliance status by Region as certified under each DLRS.
- (2) The Registry shall be publicly accessible online at no cost.
- (3) Official DLRS text is the version in the Registry; any conflict with other publications is resolved in favor of the Registry.
- (4) The Registry shall be updated within 7 days of any change in status.

(cc) **Turnout Disclosure.**

- (1) The Independent Election Commission shall publish, alongside referendum results:
    - (i) total votes cast;
    - (ii) turnout as percentage of registered voters;
    - (iii) turnout as percentage of voting-eligible population;
    - (iv) turnout compared to most recent federal election.
- (2) Low turnout does not invalidate a DLRS that achieves the required approval threshold under subsection (d)(1) or (i)(2)(A).
- (3) Congress may commission studies on turnout patterns but may not impose retroactive turnout requirements.
- (4) If turnout falls below 25 percent of voting-eligible population, the Independent Election Commission shall include in its certification a notation of low turnout and a recommendation for civic engagement measures.

(dd) **Referendum Administration.**

- (1) National referendums under subsection (d)(1) shall be administered by Regions pursuant to Article VII, Section 1.
- (2) DLRS referendums shall be scheduled to coincide with regularly scheduled federal elections to minimize costs and maximize turnout. A standalone referendum date may be designated by the Independent Election Commission only upon certification that no federal election will occur within the ratification window.
- (3) The federal government shall reimburse Regions for the reasonable costs of DLRS referendum administration within 90 days of certification. Referendum administration costs are mandatory spending not subject to annual discretionary appropriation. If Congress fails to appropriate funds within 90 days, the obligation is enforceable under Article XXI, Section 2-A.
- (4) Referendum administration costs shall be appropriated from general revenues and may not be charged against DLRS-specific funding.

(ee) **Ballot Language.**

- (1) The Independent Election Commission shall prepare official ballot language for each DLRS referendum.
- (2) Ballot language shall be neutral in tone and framing, presenting the DLRS without advocacy for or against, and shall:
    - (i) summarize the DLRS in plain language not exceeding 150 words;
    - (ii) accurately describe the floor standards being established;
    - (iii) note that higher regional or state standards are permitted;
    - (iv) identify the floor domain addressed.
- (3) Proposed ballot language shall be published for 30-day public comment before finalization.
- (4) Legal challenges to ballot language accuracy or neutrality must be filed within 30 days of finalization and resolved within 30 days.
- (5) Ballot language shall be available in all languages required for federal elections in each Region.

(ff) **Referendum Campaign Finance.**

- (1) Campaign finance disclosure requirements applicable to federal elections apply to DLRS referendum campaigns.
- (2) Foreign nationals and foreign governments may not contribute to or spend on DLRS referendum campaigns.
- (3) The Independent Election Commission shall maintain a public database of referendum campaign contributions and expenditures exceeding $10,000.
- (4) Nothing in this Section limits individual speech about DLRS proposals.
- (5) Coordination between referendum campaigns and foreign actors is prohibited and subject to penalties under federal election law.

#### Enforcement and Coordination

(gg) **Enforcement Authority.**

- (1) Rights floors established pursuant to this Section are self-executing and enforceable in all federal and Regional courts.
- (2) For all purposes of this Constitution, including but not limited to Article II, Section 3-A, rights floors established through the dual-consent process of this Section have the same constitutional status as rights established by constitutional amendment. Article II, Section 3-A(a)(iii) applies. Congressional enforcement of DLRS floor standards is not subject to the prerequisites of Article II, Section 3-A(c), provided the enforcement action is limited to the scope of the specific DLRS floor standard.
- (3) This provision does not expand congressional enforcement authority beyond the scope of the specific DLRS floor standard established through the dual-consent process.
- (4) The enforcement mechanisms established in the DLRS implementing statute (compliance certification, federal enforcement, enforcement escalation) operate as provided therein. Congress may not amend or repeal enforcement mechanisms of a DLRS implementing statute in a manner that diminishes the enforceability of floor standards without the dual-consent process of subsection (d).
- (5) Compliance with DLRS floor standards shall be assessed based on effective implementation, not merely formal legal conformity. A floor standard is not met if systemic resource deprivation, administrative obstruction, or practical inaccessibility renders the standard non-operative for a significant portion of the protected population.
- (6) Appropriations necessary for the administration and enforcement of DLRS, including the DLRS Registry, compliance certification, and enforcement escalation, are mandatory spending not subject to annual discretionary appropriation. Failure to appropriate funds for DLRS administration and enforcement constitutes obstruction of constitutional processes under Article XXI, Section 2-A.

(hh) **Relationship to Constitutional Minimums.**

- (1) DLRS floor standards supplement and do not replace the constitutional labor and safety minimums established in Article II, Section 4(h)-(k).
- (2) Where a DLRS floor standard and a constitutional minimum address the same subject matter, the higher standard governs. Where a DLRS floor standard and a constitutional minimum interact without directly conflicting, both shall be given full effect; neither shall be construed to narrow or condition the other.
- (3) DLRS authority in the labor rights domain (subsection (h)(4)) may not be construed to lower, narrow, or reclassify the constitutional minimums of Article II, Section 4(h)-(k), which are permanent and exempt from variance. DLRS may not define terms in a manner that narrows the scope of constitutional minimums.
- (4) A DLRS floor standard that exceeds a constitutional minimum of Article II, Section 4(h)-(k) is subject to the ratchet of subsection (i) with respect to the DLRS-established increment. The constitutional minimum itself remains governed by Article II, Section 4(k)(1) and is not affected by the DLRS ratchet.

(ii) **Definition of Lowering.**

- (1) For purposes of this Section, "lowering" includes any of the following relative to an existing DLRS floor standard:
    - (i) reduction in any numerical standard;
    - (ii) narrowing of the scope of protected persons, protected activities, or protected categories;
    - (iii) expansion of exemptions, exclusions, or exceptions;
    - (iv) contraction of coverage, including geographic, temporal, or subject-matter contraction;
    - (v) narrowing of definitions used in the floor standard;
    - (vi) reduction in available remedies or enforcement mechanisms;
    - (vii) any other change that, assessed by its practical effect, diminishes the protection afforded to individuals by the floor standard.
- (2) The determination of whether a change constitutes "lowering" shall be based on practical effect, not formal characterization.
- (3) A replacement DLRS under subsection (v)(2) that narrows any existing floor standard relative to the DLRS it supersedes is subject to the elevated dual-consent requirement of subsection (i)(2), not the standard dual-consent process.

(jj) **Severability.** If any subsection, paragraph, or provision of this Section is held invalid, the remaining provisions continue in full force and effect. Invalidity of a provision as applied to one Region or circumstance does not affect its validity in other Regions or circumstances.
...
Uniform national rights prevent Regional policy variation and force national political battles over every rights question. Rights floors:

- establish minimum protections everywhere
- allow Regions to exceed minimums based on local preferences
- reduce political stakes of federal elections
- preserve policy diversity

### Why Subsidiarity?

Centralized authority creates:

- democratic distance (voters far from decision-makers)
- one-size-fits-all policies for diverse populations
- winner-take-all political dynamics
...
- [DLRS Proposal](../../proposals/01-foundations/dual-legitimacy-rights-floor-statute.md) - Implementing guidance for Article III, Section 10 (Dual-Legitimacy Rights-Floor Statute)

---

## Document Navigation

- Previous: [Regional Structure](01-regional-structure.md)
- Next: [Regional Governance](03-regional-governance.md)
