...
For defense-related mutual aid with cost-sharing, readiness standards, and equalization, see Section 8 of this Article.
...
### Section 8. Defense Burden Equalization Framework

*Resolves Gap 58 — The Geographic Defense Penalty (Defense Burden Asymmetry). Ensures equitable cost-sharing for Regions bearing disproportionate defense burdens due to geographic exposure, while preserving Two-Key authorization and preventing both federal commandeering through Mutual Aid abuse and Regional infrastructure hostage-taking.*

#### Part 1 — Defense Burden Assessment

(a) **Annual Defense Burden Calculation.** The Department of Defense shall annually provide to the Independent Fiscal Council threat data and operational requirements for each Region, including:
...
- (iv) **Threat Environment Assessment**, comprising:
    ...
    - (B) Assessed capabilities of proximate foreign forces, as published by the Director of National Intelligence. The DNI assessment shall be treated as advisory; the Allocation Review Board may reject a DNI assessment upon a finding, by clear and convincing evidence, that the assessment is clearly erroneous;
    - (C) Historical pattern of foreign reconnaissance, probing, or incursion *attempts*, as classified under a validated incident-classification standard jointly established by the Department of Defense and the Allocation Review Board, including deterred attempts and hostile intent indicators;
    - (D) **Hostile Intent and Mobilization**, comprising adversary force buildup, staging activity, and declared or assessed hostile intent directed at or proximate to the Region, regardless of whether such activity has resulted in kinetic incidents;
    - (E) Volume and risk profile of cross-border traffic (commercial, migratory, maritime);
    - (F) Presence of high-value targets attractive to foreign adversaries.

The Independent Fiscal Council shall, based on the threat data and operational requirements provided by the Department of Defense, calculate each Region's "Defense Burden Index" using a published fiscal methodology. The Department of Defense shall have no authority to make final fiscal determinations affecting inter-Regional transfers under this Section.

(b) **Deterrence Credit.** A Region demonstrating measurable improvement in deterrence effectiveness — as measured by reduced successful incursions relative to validated attempt volume, including hostile intent and mobilization indicators under subsection (a)(iv)(D) — shall receive a ten percent (10%) bonus to its Defense Burden Index for the following three (3) years. The Deterrence Credit shall not be reduced solely because an adversary increases force buildup in response to effective deterrence.
...
- (iii) "Shared Benefit Infrastructure" — defense assets that provide protection beyond the host Region, as determined under subsection (n).

(d) **Methodology Transparency.** The calculation methodology shall be:

- (i) Published and subject to public comment;
- (ii) Reviewed by the Allocation Review Board for objectivity. Any Region may petition the Allocation Review Board to review Defense Burden Index calculations within sixty (60) days of publication. The Board shall defer to Independent Fiscal Council determinations on methodology absent clear error;
- (iii) Updated every five (5) years to reflect changing threat assessments.

---

#### Part 2 — Defense Burden Equalization Fund

(e) **Establishment of Fund.** There is hereby established a Defense Burden Equalization Fund ("DBEF") within the Treasury of the United States. Initial capitalization shall be provided from the federal Treasury for the first three (3) years following ratification. Beginning in year four (4), Regional contributions shall phase in, reaching full Regional funding by year five (5). The transition schedule shall be established by Congress in implementing legislation.
...
- (ii) **Capacity Contribution**: Proportional to Regional fiscal capacity (as calculated by the Independent Fiscal Council under Article X, Section 5) for remaining sixty percent (60%) of total Fund.

(g) **Disbursements.** The DBEF shall reimburse Regions for:

- (i) Excess Defense Burden costs, as certified by the Independent Fiscal Council;
...
- (iii) **Emergency Override.** Upon a declaration of national emergency by the President, pursuant to the emergency powers provisions of this Constitution, and approval by a majority vote of both chambers of Congress, the one hundred fifty percent cap under clause (i) may be suspended for the duration of the declared emergency plus one (1) fiscal year.

---

#### Part 3 — Minimum Readiness Standards with Two-Key Compliant Mutual Aid
...
(j) **Standing Defense Mutual Aid Compact.** All Regions are deemed parties to a standing Defense Mutual Aid Compact for defense-related emergencies only. For purposes of this subsection, a "qualifying defense emergency" means an emergency arising from an identified foreign military threat, hostile foreign action, cross-border incursion, or foreign-origin attack — not domestic civil disorder, natural disaster, or intra-Regional law enforcement operations. Disaster relief and non-defense mutual aid remain subject to the limitations of Section 6(b) of this Article. The Compact provides:

- (i) **Pre-Authorized Readiness.** Upon declaration of a qualifying defense emergency by any Region or the federal government, Guard units in other Regions shall be placed on deployment-ready status within twenty-four (24) hours;
...
- (iii) **Rebuttable Presumption of Authorization.** A Governor's failure to authorize deployment within seventy-two (72) hours of request creates a rebuttable presumption of bad faith, unless the Governor certifies one of the following:
    ...
    - (C) **Pretextual Request**: The Governor has substantial evidence that the defense emergency declaration is pretextual or that deployment would be used for purposes other than the declared defense emergency.

- (iv) **ARB Review of Refusal.** If a Governor refuses deployment under clause (iii)(C), the Allocation Review Board shall review the refusal within seven (7) days:
    - (A) If the Board finds the refusal unjustified, the Governor shall authorize deployment within forty-eight (48) hours;
    - (B) The refusing Region shall bear one hundred percent (100%) of costs for any alternative assistance required;
    - (C) Repeated unjustified refusals (three within five years) shall suspend the Region's eligibility to receive Defense Mutual Aid.

- (v) **Anti-Commandeering Safeguard.** Deployment under this Compact:
    - (A) Shall not exceed thirty (30) days without Congressional certification of a "Sustained Regional Defense Emergency." Extensions beyond thirty (30) days and up to ninety (90) days require such certification. No deployment under this Compact shall exceed ninety (90) days total;
    ...
    - (E) Shall not constitute a "permanent unified command," "standing joint staff," or military confederation prohibited by Section 6(a) of this Article.
...
- (i) Shall be ineligible to receive Defense Mutual Aid until standards are met;
...
Enforcement of Minimum Readiness Standards under this subsection constitutes conditions on participation in a mutual defense compact, not conditional spending within the meaning of Article X, Section 4. The Non-Coercion Standard of Article X, Section 4 does not apply to DBEF contribution requirements or disbursement conditions, which are germane to the administration of the defense equalization program within the meaning of Article X, Section 4(i)(2).

(m) **Readiness Certification.** The Allocation Review Board shall annually certify each Region's compliance with Minimum Readiness Standards based on Department of Defense assessment. Multi-Regional defense exercises under subsection (i)(iii) must be field-verified by the Department of Defense. Annual Readiness Certification is a ministerial administrative function and does not count against the filing limits of Article II, Section 4-A.

---

#### Part 4 — Shared Benefit Infrastructure with Triple-Lock Protection
...
- (i) **Presidential Nomination.** The President, upon recommendation of the Secretary of Defense, may nominate infrastructure for Shared Benefit designation by submitting to the Allocation Review Board:
    - (A) A detailed justification addressing each criterion in clause (ii);
    - (B) An assessment of the designation's impact on the host Region;
    - (C) A proposed cost-sharing arrangement.

- (ii) **ARB Certification Required.** The Allocation Review Board shall certify the designation only if it finds, by clear and convincing evidence, that:
    - (A) For national-scope assets — including intercontinental ballistic missile systems, early warning radar, satellite ground stations, and strategic command infrastructure — the asset provides defense capability extending to the nation as a whole. National-scope assets are presumptively Shared Benefit Infrastructure, subject to rebuttal by the host Region;
    - (B) For regional-scope assets, the asset provides defense capability extending beyond the host Region to at least two (2) geographically adjacent Regions, or to Regions that demonstrate specific, concrete defense benefit from the asset;
    - (C) The asset is essential to national security coordination and cannot be replicated at reasonable cost;
    - (D) Denial of access to the asset would materially impair defense of other Regions;
    - (E) The designation is not pretextual — i.e., not primarily intended to gain federal influence over the host Region's non-defense activities.
...
- (iii) **Host Region Challenge.** The host Region may challenge a proposed designation in the National Constitutional Court within thirty (30) days of ARB certification:
    - (A) The Court shall apply de novo review to the Board's findings;
...
- (iv) **Sunset and Review.** All Shared Benefit designations:
    ...
    - (C) Shall terminate automatically if the asset no longer meets the criteria in clause (ii).

Shared Benefit Infrastructure designation challenges under clause (iii) and mutual aid refusal reviews under subsection (j)(iv) are disputes that count against the filing limits of Article II, Section 4-A.
...
- (iii) **Federal Operational Assumption requires Triple Lock:**
    - (A) Allocation Review Board finding of systematic access denial; AND
...
#### Part 5 — Anti-Gaming Provisions

(q) **Prohibited Burden Inflation.** A Region shall not:
...
- (iv) Acquire capabilities or incur costs that exceed the National Minimum Readiness Standards established under subsection (i) by more than twenty percent (20%) without prior fiscal certification by the Independent Fiscal Council and operational certification by the Allocation Review Board. Costs exceeding this threshold without prior certification are ineligible for DBEF reimbursement.

(r) **Audit Authority.** The Government Accountability Office shall:

- (i) Conduct biennial audits of DBEF contributions and disbursements;
- (ii) Review Defense Burden calculations for accuracy;
- (iii) Report findings to Congress and the Allocation Review Board.

(s) **Penalty for Fraud.** A Region found to have engaged in Prohibited Burden Inflation:
...
#### Part 6 — Coordination and Savings

(t) **National Necessity Savings Clause.** Nothing in this Section shall be construed to limit federal eminent domain authority under Article II, Section 17 (National Necessity Easement). Where a certified National Necessity project requires access to infrastructure designated as Shared Benefit under subsection (n), the host Region shall provide access upon request, subject to the accommodation requirements of Article II, Section 17(d). Access for National Necessity purposes does not require the Triple Lock procedures of subsection (p)(iii).

(u) **Independent Fiscal Council Methodology.** The Independent Fiscal Council shall publish, annually, the methodology for calculating Excess Defense Burden, DBEF contribution schedules, and disbursement certifications. The Independent Fiscal Council's certified fiscal capacity data for the current fiscal year is the sole authoritative source for all DBEF calculations; no parallel data source may be substituted. Any Region may petition the Council to review Defense Burden Index calculations within sixty (60) days of publication. The Allocation Review Board shall defer to Independent Fiscal Council determinations on fiscal methodology absent clear error; the Board's separate objectivity review under subsection (d)(ii) addresses threat-data accuracy, not fiscal methodology.
