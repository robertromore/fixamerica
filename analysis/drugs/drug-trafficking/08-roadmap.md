...
freshness:
  ...
  sections:
    ...
    - name: "Success Metrics"
      data-year: 2024
notes:
  - Budget estimates based on FY2025 ONDCP data and CBO projections
  - Timeline assumes new administration beginning 2025
  - International cooperation milestones depend on diplomatic conditions
sources:
  count: 0
  verified: 2025-01-28
  broken: 0
...
# Drug Trafficking: Implementation Roadmap
...
- Deploy non-intrusive inspection (NII) technology at 50 highest-volume ports of entry
- Triple FinCEN analytical capacity and begin Corporate Transparency Act implementation
...
|--------|-----------|----------|------------------|----------------|
| Procure and install 100 NII systems at top 50 ports of entry | CBP | Months 1-18 | $2 billion procurement; 500 new CBP officers | NII coverage at 50 top ports; scanning rate >40% of commercial vehicles |
| Triple FinCEN staff from 300 to 900 analysts | Treasury/FinCEN | Months 1-12 | $300 million annually; federal hiring authority | SAR analysis rate increases from <20% to 50% |
| Launch CTA beneficial ownership database | FinCEN | Months 1-6 | Per CTA requirements | Database operational; 5+ million entities registered |
...
- FY2026 supplemental appropriation for NII technology procurement ($2 billion)
...
## Phase 2: Strategic Rebalancing and Partnership Modernization (Years 3-5)

### Objectives

- Achieve 100% NII scanning coverage at all 328 ports of entry
- Rebalance federal drug control budget from 57/43 to 50/50 (supply/demand)
...
| Action | Lead Actor | Timeline | Resources Needed | Success Metric |
|--------|-----------|----------|------------------|----------------|
| Deploy NII at remaining 278 ports of entry | CBP | Months 24-48 | $3 billion additional procurement; 1,000 new officers | 100% NII coverage; scanning rate >80% |
| Rebalance ONDCP budget to 50/50 split | ONDCP/Congress | FY2028-2029 | Redirect ~$3.2 billion from supply to demand programs | Budget ratio reaches 50/50 |
| Replace Bicentennial Framework with modernized partnership | State/DOJ | Months 24-36 | $1.5 billion redirected assistance | Joint financial intelligence units operational in 5 Mexican states |
| Implement cryptocurrency AML regulations | FinCEN/SEC | Months 24-36 | $200 million for technology and enforcement | All crypto exchanges subject to BSA reporting |
...
- Multi-year NII procurement authorization ($3 billion)
- Cryptocurrency Anti-Money Laundering Act passage
...
## Phase 3: Demand Reduction at Scale and Sustainable Counter-Trafficking (Years 6-10)

### Objectives

- Achieve 40/60 supply/demand budget ratio
- Close treatment gap to below 40% (from 76% baseline)
...
| Action | Lead Actor | Timeline | Resources Needed | Success Metric |
|--------|-----------|----------|------------------|----------------|
| Achieve 40/60 budget ratio | ONDCP/Congress | FY2031-2035 | Redirect additional $4.6 billion to demand reduction | 40/60 ratio sustained |
| Expand MAT access to all correctional facilities | BOP/state DOCs | Years 6-10 | $1 billion annually | 100% of incarcerated individuals with OUD offered MAT |
...
|-----------|-------------|--------|-------------------|---------------|---------------|----------------|
| Overdose deaths | Ongoing | Annual deaths | 107,543 (2023) | 90,000 | 75,000 | 54,000 |
| Fentanyl interdiction rate | Ongoing | % of supply intercepted | 5-10% | 15-20% | 25-30% | 30-40% |
| Drug control budget ratio (supply/demand) | Annual | Budget allocation | 57/43 | 53/47 | 50/50 | 40/60 |
| Treatment gap | Annual | % with SUD receiving no treatment | 76% | 65% | 55% | 40% |
| SAR analysis rate | Annual | % of SARs analyzed by FinCEN | <20% | 50% | 80% | 90% |
...
- **ONDCP**: Primary coordinating body for the National Drug Control Strategy, responsible for budget certification, interagency coordination, and annual progress reporting to Congress
- **Congressional oversight**: Senate Caucus on International Narcotics Control and House Judiciary Committee receive quarterly briefings on implementation progress
...
### Risk 1: Political Reversal of Demand Reduction Investment

**Likelihood**: High

**Impact**: High

**Mitigation Strategy**: Build bipartisan support by framing demand reduction as "defunding the cartels." Lock in funding through multi-year authorizations with sunset provisions requiring affirmative Congressional action to terminate. Build state-level coalitions that sustain programs regardless of federal policy shifts.

**Contingency Plan**: If federal demand reduction funding is cut, prioritize state-level funding mechanisms (Medicaid expansion, state block grants) and philanthropic partnerships to maintain minimum treatment capacity.

### Risk 2: U.S.-China Relations Deterioration Undermines Precursor Cooperation
...
### Risk 4: NII Technology Deployment Slows Trade at Border

**Likelihood**: Medium

**Impact**: Medium

**Mitigation Strategy**: Negotiate pre-clearance arrangements with Mexico for northbound commercial traffic. Deploy AI-assisted risk assessment to prioritize high-risk vehicles for secondary inspection. Invest in infrastructure to expand port capacity alongside scanning capacity.

**Contingency Plan**: If trade delays become severe, implement trusted trader programs that allow pre-screened companies to use expedited lanes, focusing NII resources on unknown or high-risk shipments.

### Risk 5: Dark Web Markets Evolve Faster Than Enforcement

**Likelihood**: High

**Impact**: Low-Medium

**Mitigation Strategy**: Maintain a dedicated, well-resourced digital task force with private-sector technology partnerships. Focus on marketplace infrastructure (hosting, payment processing) rather than individual vendors. Build international cooperation for cross-jurisdictional takedowns.
...
- **NII systems**: 400+ non-intrusive inspection systems across 328 ports of entry
