...
freshness:
  ...
  sections:
    ...
    - name: "Phase 2 Actions"
      data-year: 2024
    - name: "Phase 3 Actions"
      data-year: 2024
    - name: "Resource Requirements"
      data-year: 2024
notes:
  - Review annually to update cost estimates and milestone targets.
  - Adjust timelines based on congressional session progress.
  - Update bed count baselines when Treatment Advocacy Center releases new data.
sources:
  count: 14
  verified: 2026-01-29
  broken: 0
...
# Inpatient Psychiatric Care: Implementation Roadmap

## Strategic Approach

Rebuilding America's inpatient psychiatric care infrastructure requires a sequenced, three-phase strategy that begins with executive and regulatory actions that can be taken without new legislation, progresses to major legislative reforms, and culminates in a decade-long transformation of the psychiatric care landscape. Each phase builds on the preceding one: Phase 1 establishes the financial and informational foundations; Phase 2 enacts the structural reforms and begins construction; Phase 3 completes the buildout and achieves target capacity.

The strategy is grounded in a recognition that the psychiatric bed crisis is fundamentally a financing crisis. The IMD exclusion distorts the entire market for psychiatric inpatient care, and no amount of incremental investment will overcome its effects. Therefore, the roadmap prioritizes removing the IMD exclusion as the central legislative action, while simultaneously building the workforce, crisis stabilization infrastructure, and data systems needed to ensure that new capacity is used effectively.
...
- Expand IMD waiver access to all 50 states as a bridge to full repeal
- Launch national psychiatric bed registry development and pilot deployment
...
|--------|-----------|----------|------------------|----------------|
| Expand Section 1115 IMD waivers to all states; increase stay limit from 30 to 60 days | CMS | Months 1-6 | Existing CMS waiver authority; estimated $2-3 billion/year in new federal Medicaid spending | All 50 states with active IMD waivers by Month 12 |
| Issue joint CMS/DOL enforcement guidance strengthening MHPAEA for inpatient care | CMS, Department of Labor | Months 3-9 | Existing regulatory authority | Guidance published by Month 9 |
| Fund national psychiatric bed registry development; select 5 pilot states | SAMHSA | Months 1-12 | $50 million initial appropriation | Registry operational in 5 pilot states by Month 18 |
| Award first round of crisis stabilization unit (CSU) construction grants | SAMHSA | Months 6-18 | $300 million (Year 1 of $1.5 billion 5-year program) | 50 CSU grants awarded by Month 18 |
...
- Appropriations bill or continuing resolution including $600 million for CSU grants, bed registry development, and workforce programs (Year 1)
- Medicare GME expansion legislation authorizing 200 additional psychiatric residency positions
- No new legislation required for IMD waiver expansion or MHPAEA enforcement guidance (executive authority)
...
- Enact full IMD exclusion repeal through legislation
- Launch Federal Psychiatric Infrastructure Investment Program
...
| Action | Lead Actor | Timeline | Resources Needed | Success Metric |
|--------|-----------|----------|------------------|----------------|
| Enact IMD exclusion repeal legislation | Congress | Year 3 | CBO-estimated $10-15 billion/year in new Medicaid spending | Legislation signed by end of Year 3 |
| Launch Federal Psychiatric Infrastructure Investment Program (first construction grants) | SAMHSA/HRSA | Year 3-4 | $1 billion/year for 5 years ($5 billion total) | First 100 construction grants awarded by Year 4 |
| Deploy national bed registry to all 50 states | SAMHSA | Year 3 | $15-20 million/year for operations | Registry operational in all 50 states by end of Year 3 |
| Award remaining CSU grants (total 500+) | SAMHSA | Years 3-5 | $300 million/year (Years 3-5) | 500 CSUs operational by Year 5 |
...
- IMD exclusion repeal bill (amending 42 U.S.C. 1396d to remove the IMD exclusion)
...
- Achieve minimum 30 psychiatric beds per 100,000 population nationally
- Complete state psychiatric hospital modernization program
...
| Action | Lead Actor | Timeline | Resources Needed | Success Metric |
|--------|-----------|----------|------------------|----------------|
| Continue infrastructure investment grants (remaining $2 billion) | SAMHSA/HRSA | Years 6-8 | $1 billion/year (Years 6-7) | Cumulative 300+ facility grants awarded |
| Complete state psychiatric hospital modernization (remaining projects) | SAMHSA/States | Years 6-10 | $300 million/year federal + state match | All priority facilities modernized by Year 10 |
| Expand crisis stabilization network to 1,000+ CSUs | SAMHSA | Years 6-10 | Ongoing Medicaid reimbursement | 1,000 CSUs operational by Year 10 |
...
|-----------|-------------|--------|-----------------|---------------|---------------|----------------|
| Psychiatric bed capacity | Year 10 | Beds per 100,000 population | 11.7 | 15.0 | 20.0 | 30.0+ |
| ED boarding | Year 5 | Average wait time (hours) | 8.0 | 5.0 | 3.0 | <2.0 |
| 30-day readmission rate | Year 10 | All-payer readmission rate | 19.3% | 17.0% | 15.0% | <12.0% |
| Crisis stabilization units | Year 10 | Operational CSUs nationwide | ~200 | 250 | 500 | 1,000+ |
| Psychiatric workforce | Year 10 | Psychiatrists per 100,000 | 15.6 | 16.5 | 18.0 | 20.0+ |
...
### Risk 1: Congressional Failure to Enact IMD Repeal
...
### Risk 2: Workforce Shortages Limiting Capacity Expansion

**Likelihood**: High

**Impact**: High -- new beds without staff to operate them provide no benefit.
...
**Impact**: Medium -- delays or prevents construction in specific locations, not the program overall.
...
- **Federal**: Approximately 200-300 new FTEs across SAMHSA, CMS, and HRSA for program administration, grant management, quality oversight, and bed registry operations
- **State**: Each state mental health authority will need 5-15 additional staff for grant management, facility licensing, bed registry coordination, and quality monitoring (total: 250-750 state FTEs)
- **Clinical workforce**: Target net addition of 5,000+ psychiatrists, 10,000+ psychiatric nurses, and 15,000+ other psychiatric professionals over 10 years to staff expanded capacity
