# Inpatient Psychiatric Care: Solutions

Rebuilding America's inpatient psychiatric care system requires a multi-faceted approach that aims to eliminate the financial distortions that created the bed shortage, expand capacity through both public and private investment, build the psychiatric workforce, create alternatives to emergency department boarding, and establish quality standards that prevent a return to institutional neglect.
...
- Address the root financial cause (IMD exclusion) rather than layering incremental patches over a broken financing structure
- Expand inpatient capacity and community services simultaneously, rejecting the false choice between institutional and community-based care
...
### Solution 1: Repeal the IMD Exclusion
...
**Timeline**: Authorization within 1-2 years; first construction grants awarded by Year 2; first new beds online by Year 4.

**Challenges**: Capital construction timelines (18-36 months per facility); workforce to staff new beds; NIMBY opposition to facility siting; ensuring beds are used for acute care, not long-term warehousing.

**Impact Metrics**: Number of new beds constructed by state; beds per 100,000 population change; geographic access (percentage of population within 60 miles of psychiatric inpatient bed).

### Solution 3: National Psychiatric Bed Registry
...
**Timeline**: Residency positions begin filling within 2 years; first loan repayment cohort active by Year 2; workforce impact measurable by Year 5 (psychiatry residency is 4 years).
...
**Timeline**: First CSUs funded by Year 1; target network of 500+ CSUs operational by Year 5.
...
**Timeline**: Regulatory guidance within 12 months; legislative amendments within 2 years.

**Challenges**: Insurance industry lobbying against stronger enforcement; difficulty defining "parity" in clinical terms; potential premium increases.

**Impact Metrics**: Average authorized length of stay (commercial insurance); denial rates for psychiatric inpatient claims; reimbursement rate ratios (psychiatric vs. medical/surgical); parity compliance audit results.

### Solution 7: State Psychiatric Hospital Modernization Program
...
**Timeline**: First grants awarded by Year 2; first modernized facilities completed by Year 5.

**Challenges**: Construction timelines and cost overruns; maintaining operations during renovation; state budget constraints for matching funds.

**Impact Metrics**: Number of facilities modernized; seclusion and restraint rates; patient and staff safety incident rates; accreditation outcomes.

---

## International Models

### Australia: Mental Health Bed and Community Integration Model
...
### United Kingdom: Crisis Resolution and Home Treatment Teams
...
- Expand Section 1115 IMD waivers to all states and increase stay limits from 30 to 60 days
...
- Launch psychiatric infrastructure investment program with first construction grants
...
- Achieve minimum 30 beds per 100,000 population nationally (from 11.7 in 2024)
