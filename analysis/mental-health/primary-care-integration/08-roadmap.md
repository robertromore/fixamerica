...
freshness:
  ...
  sections:
    ...
    - name: "Success Metrics"
      data-year: 2024
notes:
  - Timeline assumes first legislation enacted in 2026; adjust phases accordingly
  - Cost estimates based on CBO scoring methodology and HRSA program data
  - FQHC integration timeline aligned with HRSA Section 330 grant cycles
sources:
  count: 18
  verified: 2026-01-29
  broken: 0
...
# Primary Care and Mental Health Integration: Implementation Roadmap

## Strategic Approach

Achieving universal integration of behavioral health into primary care requires coordinated, simultaneous action across four interdependent domains: payment reform, workforce development, technology infrastructure, and organizational transformation. No single domain can succeed in isolation because the barriers reinforce each other. A practice cannot sustain integrated care without adequate payment; payment cannot drive adoption without a trained workforce; workforce cannot be effective without enabling technology; and technology investments are wasted without organizational commitment to team-based care.

The roadmap is organized into three phases that progressively expand the reach and depth of integration. Phase 1 (Years 1-2) establishes the financial and regulatory foundation by mandating payer coverage and launching workforce and technology programs. Phase 2 (Years 3-5) scales adoption through targeted deployment of new workers, expanded technical assistance, and enforcement of integration standards. Phase 3 (Years 6-10) achieves near-universal integration, transitions to sustainable financing, and embeds integration as the standard of primary care practice.
...
- Establish universal payer coverage for CoCM billing codes (Medicare, Medicaid, commercial)
- Launch the Behavioral Health Care Manager (BHCM) Corps and certification program
...
|--------|-----------|----------|------------------|----------------|
| Enact Primary Care Behavioral Health Integration Act (federal legislation) | Congress | Months 1-12 | Legislative staff; CBO scoring | Legislation signed into law |
| CMS issues final rule mandating Medicaid CoCM coverage in all 50 states | CMS | Months 6-18 | Rulemaking staff; state consultation | Rule published in Federal Register |
| HRSA launches BHCM Corps program design and accreditation standards | HRSA/SAMHSA | Months 1-12 | $50 million planning grant; interagency working group | Accreditation standards published; first training sites approved |
| ONC issues proposed rule for EHR behavioral health integration certification | ONC | Months 6-12 | Rulemaking capacity; vendor consultation | Proposed rule published; comment period opened |
| HRSA awards competitive grants for 30 new psychiatric access programs (adult) | HRSA | Months 6-18 | $100 million in Year 1 grants | 30 new state programs awarded |
...
- Achieve Medicaid CoCM coverage in all 50 states with enforcement of minimum rate floors
- Deploy the first 5,000 certified BHCMs through the BHCM Corps
- Achieve all-state coverage of adult and child psychiatric access programs (50 states)
...
| Action | Lead Actor | Timeline | Resources Needed | Success Metric |
|--------|-----------|----------|------------------|----------------|
| Enforce Medicaid CoCM coverage compliance across all 50 states | CMS | Year 3 | State Plan Amendment review staff | 50/50 states covering CoCM codes |
| Deploy first 2,000 certified BHCMs to integrated care settings | HRSA (BHCM Corps) | Year 3 | $300 million/year (training + deployment) | 2,000 BHCMs in practice; 60%+ in MHPSAs |
| Award remaining psychiatric access program grants (20 additional states) | HRSA | Years 3-4 | $100 million/year | 50 states with adult + child programs |
| Expand Project ECHO hubs to 100 total | HRSA | Years 3-5 | $50 million/year | 100 hubs serving 20,000+ practices |
| Large FQHCs (500+ patients/site) achieve Level 5-6 integration | HRSA/FQHCs | Year 3-4 | $600 million/year in integration grants | 80% of large FQHCs at Level 5-6 |
| ONC finalizes EHR behavioral health integration certification requirements | ONC | Year 3 | Final rule publication | Final rule effective; 24-month vendor compliance clock starts |
...
- Achieve 60%+ of primary care practices delivering integrated behavioral health (Level 4-6)
- Deploy 10,000 BHCMs; establish self-sustaining training pipeline
- Complete FQHC universal integration (all sites at Level 5-6)
...
| Action | Lead Actor | Timeline | Resources Needed | Success Metric |
|--------|-----------|----------|------------------|----------------|
| Reach 10,000 certified BHCMs deployed in integrated settings | HRSA (BHCM Corps) | Year 7 | Ongoing $300 million/year | 10,000 BHCMs; retention rate above 80% at 3 years |
| All FQHCs achieve Level 5-6 integration compliance | HRSA | Year 5-7 | Final phase integration grants | 100% of FQHC grantees at Level 5-6 |
| 35+ states operating carved-in behavioral health Medicaid | State Medicaid agencies | Years 6-8 | Enhanced FMAP (final years) | 35+ states carved in |
| All ACGME-accredited primary care residencies include integrated care training | ACGME/residency programs | Year 7-8 | Training grants transitioning to program self-funding | 100% compliance with ACGME standards |
| Transition BHCM Corps funding to sustainable loan repayment model (NHSC-style) | HRSA/Congress | Years 7-10 | Reauthorization legislation; ongoing $150 million/year | Self-sustaining pipeline producing 2,000+ BHCMs/year |
| EHR behavioral health integration features standard across all certified products | ONC | Year 6-7 | Ongoing certification enforcement | 100% of certified EHRs compliant |
...
|-----------|-------------|--------|-------------------|---------------|---------------|----------------|
| CoCM adoption | Ongoing | % of primary care practices billing CoCM codes | Fewer than 3% (2023) | 10% | 25% | 60% |
| BHCM deployment | Year 7 | Number of certified BHCMs in practice | Under 10,000 (2023) | 2,000 new certifications | 5,000 cumulative | 10,000 cumulative |
| FQHC integration | Year 7 | % of FQHCs at Level 5-6 integration | Fewer than 15% (2023) | 40% | 80% (large sites) | 100% |
| Psychiatric access programs | Year 5 | States with adult + child programs | ~15 states (adult); 40+ (child) | 35 states (adult) | 50 states (adult + child) | 50 states (sustained) |
| Medicaid CoCM coverage | Year 3 | States covering CoCM codes under Medicaid | 22 states (2023) | 50 states | 50 states (enforced) | 50 states (permanent) |
...
- **Annual HHS report to Congress**: Required under the authorizing legislation, covering all metrics, spending, and program performance
...
### Risk 1: Congressional Failure to Pass Comprehensive Legislation
...
### Risk 2: Insufficient Workforce Supply to Meet Deployment Targets
...
### Risk 4: EHR Vendor Resistance to Integration Standards
...
### Risk 5: Political Changes Reversing Integration Commitments
...
|-------|----------------|----------------|-------|
| Phase 1 (Years 1-2) | $2.5 billion | New federal appropriation; enhanced FMAP | Legislation + supplemental for psychiatric access/ECHO expansion |
| Phase 2 (Years 3-5) | $6.5 billion ($2.2 billion/year average) | Authorized appropriation; state match for FMAP | BHCM Corps scale-up; FQHC grants; ECHO expansion; Medicaid enhanced match |
| Phase 3 (Years 6-10) | $7.0 billion ($1.4 billion/year average) | Transitioning to sustainable payment models | Declining grants; increasing self-sustaining reimbursement revenue |
| **Total (10 years)** | **$16.0 billion** | **Federal appropriation + state match** | **Partially offset by estimated $8-12 billion in reduced ED/hospitalization costs** |

### Personnel

- **Federal staff**: Approximately 200 new FTEs across CMS, HRSA, SAMHSA, and ONC for program administration, rulemaking, and oversight (Years 1-5)
- **BHCM Corps**: 10,000 new certified BHCMs by Year 7, plus 500+ training program faculty and supervisors
