...
freshness:
  ...
  sections:
    ...
    - name: "Success Metrics"
      data-year: 2024
notes:
  - Timelines assume FY2026 start; adjust if legislative authorization is delayed
  - Cost estimates use FY2024 dollars unless otherwise noted
  - Suicide reduction targets aligned with VA National Strategy for Preventing Veteran Suicide
sources:
  count: 0
  verified: 2026-01-29
  broken: 0
...
# Veterans Mental Health: Implementation Roadmap

## Strategic Approach

Reforming veterans mental health requires a phased strategy that balances immediate crisis response with long-term structural transformation. The roadmap is organized around four strategic pillars: (1) workforce expansion, (2) upstream suicide prevention, (3) system integration, and (4) clinical quality improvement. These pillars are interdependent -- expanding the workforce enables better access, which enables better quality monitoring, which supports evidence-based suicide prevention.

The theory of change is straightforward: veteran mental health outcomes will improve when every veteran can access a qualified, military-competent mental health professional within 14 days; when suicide prevention efforts reach the 60.6% of veteran suicide decedents not engaged with VA care; when evidence-based treatments are delivered with fidelity across VA and community settings; and when the DoD-VA transition gap is eliminated. The three phases below build toward these conditions sequentially, with each phase creating the preconditions for the next.
...
- Triple the Staff Sergeant Parker Gordon Fox Suicide Prevention Grant Program to $500 million annually
- Launch the National Veterans Mental Health Workforce Initiative with immediate hiring incentives
...
|--------|-----------|----------|------------------|----------------|
| Increase EDRP loan repayment cap from $200,000 to $300,000 for shortage areas | VA Secretary / Congress | Months 1-6 | $160 million/year | Psychiatrist vacancy rate reduction to <30% |
| Triple Fox Suicide Prevention Grant Program | Congress (appropriation) | Months 1-6 | $500 million/year (up from $174 million) | Community outreach contacts doubled |
| Launch mandatory military cultural competency certification for Community Care providers | VA Office of Community Care | Months 6-18 | $30 million for curriculum/delivery | Certification enrollment >5,000 providers by Month 18 |
| Deploy 50 mobile mental health units to Guard/Reserve populations | VA / National Guard Bureau | Months 6-18 | $75 million (capital + staffing) | Units operational in 30 states |
...
- **Veterans Mental Health Workforce Act**: Authorize increased EDRP caps, new training slots, and geographic incentive pay (see 11-legislation.md for draft text)
- **Fox Grant Program Expansion**: Appropriation increase from $174 million to $500 million annually within VA OMHSP budget
- **Community Care Quality Standards Act**: Authorize mandatory military competency certification as a condition of Community Care mental health enrollment
...
## Phase 2: Structural Reform and Scaling (Years 3-5)

### Objectives

- Hire 10,000 new mental health professionals through the National Workforce Initiative
- Achieve DoD-VA electronic health record interoperability for mental health
...
| Action | Lead Actor | Timeline | Resources Needed | Success Metric |
|--------|-----------|----------|------------------|----------------|
| Fill 10,000 new VA mental health positions | VA HR / Workforce Initiative | Years 2-5 | $2.5 billion over 5 years (total initiative) | Vacancy rate <10%; wait times <14 days |
| Achieve DoD-VA EHR interoperability for mental health records | VA OIT, DoD DHA, Joint Executive Committee | Years 2-4 | $200 million for interoperability bridge | Bidirectional MH record access at all separation points |
| Establish 10 Psychedelic-Assisted Therapy Centers of Excellence | VA Office of Research and Development | Years 2-4 | $500 million over 5 years (trials + Centers) | 5,000 veterans enrolled in trials by Year 5 |
| Deploy suicide prevention coordinators in 800 counties | VA OMHSP / Community partners | Years 2-4 | $150 million (3 years of coordinator salaries + support) | Coordinators operational in 800 counties with 5,000+ veterans |
| Implement warm handoff protocol at all major military installations | DoD / VA Transition Office | Years 2-4 | $200 million (transition coordinators + dual enrollment) | 95% of at-risk separating members have scheduled VA MH appointment |
...
- **Seamless Transition Act**: Mandate warm handoffs, dual enrollment, and EHR interoperability for all separating service members with mental health conditions
...
- Achieve a 40% reduction in veteran suicide from the 2021 baseline
- Establish permanent mental health workforce pipeline that prevents future shortage cycles
...
| Action | Lead Actor | Timeline | Resources Needed | Success Metric |
|--------|-----------|----------|------------------|----------------|
| Sustain and expand workforce pipeline through permanent training programs | VA Academic Affiliations / HRSA | Years 6-10 | $400 million/year (ongoing) | Net positive provider growth annually |
| Integrate psychedelic-assisted therapy into standard care (if warranted) | VA OMHSP / FDA | Years 6-8 | $300 million for clinical scaling | 50+ VA sites offering psychedelic-assisted therapy |
...
|-----------|-------------|--------|-------------------|---------------|---------------|----------------|
| Veteran suicide rate | Year 10 | Deaths per day | 17.5 (2021) | 15.5 | 14.0 | <10.5 |
| VA MH vacancy rate | Year 5 | Unfilled positions | ~4,600 | 3,000 | <1,500 | <1,000 |
| Wait time (new MH appointment) | Year 5 | Average days | 29.6 days (some sites) | <20 days | <14 days | <14 days |
| Non-VA-user suicides | Year 10 | Percentage of decedents | 60.6% | 55% | 45% | <35% |
| Community Care MH certification | Year 5 | Provider certification rate | <10% trained | 40% | 100% | 100% |
...
### Risk 1: National Mental Health Workforce Shortage Limits VA Recruitment
...
### Risk 2: Political Resistance to Psychedelic-Assisted Therapy
...
### Risk 3: Community Care Providers Refuse Mandatory Certification
...
### Risk 4: DoD-VA EHR Interoperability Fails (Again)
...
### Risk 5: Budget Reduction or Sequestration Cuts Funding
