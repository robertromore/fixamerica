...
freshness:
  ...
  review-cycle: 6
  sections:
    - name: "Claims Denial Disparities"
      data-year: 2023
    - name: "Network Adequacy"
      data-year: 2024
    - name: "2024 Final Rule"
      data-year: 2024
notes:
  - Milliman publishes updated parity analyses approximately every 2-3 years; next update expected 2025-2026
  - 2024 final rule compliance deadlines phased through 2026; enforcement data will emerge in 2026-2027
  - SAMHSA NSDUH releases annual data with approximately 18-month lag
sources:
  count: 24
  verified: 2026-01-28
  broken: 0
...
# Mental Health Insurance Parity: Current State

## Claims Denial Disparities

The most direct measure of parity compliance is whether MH/SUD claims are denied at rates comparable to medical/surgical claims. Available data consistently shows they are not.

### Denial Rate Comparison

| Benefit Category | Average Denial Rate | Denial Rate Ratio (MH/SUD to Med/Surg) | Source |
|---|---|---|---|
| Mental health inpatient | 22.4% | 1.9x | Milliman, 2023 |
| Substance use disorder inpatient | 24.8% | 2.1x | Milliman, 2023 |
| Mental health outpatient | 18.6% | 1.7x | Milliman, 2023 |
...
| Metric | MH/SUD | Medical/Surgical | Source |
|---|---|---|---|
| Services requiring prior authorization | 30-40% | 10-15% | APA Practice Survey, 2023 |
...
| Metric | Value | Source |
|---|---|---|
| MH/SUD denials appealed by patients | 0.5% | DOL EBSA, 2023 |
...
The most reliable indicator of network adequacy is the rate at which patients must go out-of-network to obtain care. Behavioral health services consistently show far higher out-of-network utilization.

| Service Category | Out-of-Network Rate | Comparison to Med/Surg | Source |
|---|---|---|---|
...
Low reimbursement rates are the primary reason behavioral health providers decline to participate in insurer networks.

| Metric | Value | Trend | Source |
|---|---|---|---|
| MH/SUD reimbursement as % of Medicare rates | 77-83% | Stable/declining | Milliman, 2024 |
| Medical/surgical reimbursement as % of Medicare rates | 105-130% | Stable | Milliman, 2024 |
...
NQTLs are the design features of insurance plans -- such as prior authorization criteria, step therapy requirements, medical necessity standards, and network admission requirements -- that do not impose numerical limits but can effectively restrict access to care. They are the primary mechanism through which modern parity violations occur.

### Common NQTL Disparities

| NQTL Type | MH/SUD Application | Medical/Surgical Application | Parity Concern |
|---|---|---|---|
...
The 2024 final rule (89 Fed. Reg. 77586) requires plans to conduct comparative analyses demonstrating that NQTLs are no more restrictive for MH/SUD benefits than for medical/surgical benefits. Key requirements include:

| Requirement | Deadline | Description |
|---|---|---|
| Comparative analysis documentation | January 1, 2025 | Plans must maintain written analyses for each NQTL |
| Data collection for outcomes | Plan years beginning on/after January 1, 2025 | Plans must collect data on NQTL impact |
...
EBSA is the primary federal enforcer of MHPAEA for employer-sponsored plans governed by ERISA, covering approximately 136 million people.

| Metric | FY2022 | FY2023 | Trend | Source |
|---|---|---|---|---|
| MHPAEA investigations initiated | 185 | 206 | Upward | DOL EBSA Annual Report, 2023 |
| Violations found | 142 | 168 | Upward | DOL EBSA, 2023 |
| Plans required to make corrections | 87 | 112 | Upward | DOL EBSA, 2023 |
| Monetary recoveries | $3.2 million | $4.8 million | Upward | DOL EBSA, 2023 |
...
CMS enforces parity for individual and small group market plans and for certain Medicaid managed care plans.
...
| Metric | Value | Source |
|---|---|---|
| States with parity enforcement programs | 39 + D.C. | NAMI, 2024 |
...
|---|---|---|---|
| MH/SUD claims denial rate | 22.4% | Stable/worsening | Compared to 11.7% med/surg |
| Out-of-network MH/SUD utilization | 16.3% (office visits) | Stable | 5.4x higher than med/surg |
| MH/SUD reimbursement gap | 20-40% below med/surg | Widening | Primary driver of network inadequacy |
| DOL parity investigations | 206 (FY2023) | Increasing | Up from 67 in FY2018 |
...
|---|---|---|
| **Mental Health Parity Act (MHPA)** | 1996 | Required equal annual and lifetime dollar limits for MH benefits (limited scope) |
| **Mental Health Parity and Addiction Equity Act (MHPAEA)** | 2008 | Extended parity to SUD; covered financial requirements and quantitative treatment limitations |
...
State-level parity enforcement varies dramatically, creating uneven protections depending on where a person lives and whether their plan is fully insured (regulated by the state) or self-insured (regulated by DOL).

### State Parity Enforcement Tiers

| Tier | Description | Number of States | Examples |
|---|---|---|---|
| **Strong** | Dedicated parity staff, proactive audits, public reporting, penalties | 12 | CT, IL, CO, OR, MA |
| **Moderate** | Parity law exceeds federal, complaint-driven enforcement | 17 | CA, NY, MD, NJ, WA |
