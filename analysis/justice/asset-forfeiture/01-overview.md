...
Civil asset forfeiture allows law enforcement to seize property suspected of being connected to criminal activity—often without charging the owner with any crime. Originally designed to disrupt organized crime and drug trafficking, this practice has expanded dramatically, creating a system where innocent Americans can lose their cash, cars, and homes based on mere suspicion, with the burden falling on them to prove their innocence.

This represents one of the most significant due process failures in American law. Each year, federal and state agencies seize billions of dollars in assets from citizens, with law enforcement agencies directly benefiting from the proceeds. This creates perverse incentives that prioritize revenue generation over justice.
...
- Federal programs including equitable sharing
- Reform efforts and their outcomes
- Model legislation for meaningful reform

## Key Statistics

| Metric | Value | Source/Year |
|--------|-------|-------------|
| Federal forfeiture fund balance | $9.1 billion | DOJ/Treasury 2023 |
| Annual federal forfeitures | $2-4 billion | DOJ Reports |
| States requiring conviction | 17 | Institute for Justice 2024 |
| Median cash seizure (DEA highways) | $1,976 | DOJ OIG 2017 |
| Seizures under $1,000 | 60%+ | Multiple state audits |
| Property returned to owners | ~1% | Various state data |
| Average time to contest forfeiture | 1-2 years | Legal aid organizations |
| Cost to contest $500 seizure | $2,000-10,000 | Attorney fee estimates |
...
- **Families** are torn apart fighting to recover essential assets
- **Communities** lose trust in law enforcement
...
4. **Independent disposition** of forfeiture proceeds (general fund, not police budgets)
5. **Enhanced reporting** and transparency requirements
6. **Right to counsel** for contested forfeitures
7. **Innocent owner protections** codified and strengthened
...
| Subtopic | Connection |
|----------|------------|
| [Policing](../policing/01-overview.md) | Police seizures, equitable sharing |
| [Fines and Fees](../fines-and-fees/01-overview.md) | Revenue-driven justice |
| [Civil Rights Enforcement](../civil-rights-enforcement/01-overview.md) | Due process, constitutional challenges |
| [Courts](../courts/01-overview.md) | Burden of proof, innocent owner defense |
