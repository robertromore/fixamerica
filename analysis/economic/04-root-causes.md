...
- Innovation protected but also restricted

### Globalization of Capital, Localization of Labor
...
- Benefits of globalization distributed unequally
...
- Bankruptcy used strategically against workers
...
- Benefits and protections eliminated

## Economic Causes

### Declining Worker Bargaining Power

Multiple factors have shifted power from workers to employers:

**Union Decline**

| Factor | Impact |
|--------|--------|
| Hostile labor law interpretation | NLRB turned anti-union since 1980s |
| Right-to-work laws | Now in 27 states |
| Employer tactics | Aggressive union avoidance legal |
| Deindustrialization | Eliminated heavily unionized sectors |
...
- Enforcement of existing laws inadequate
...
- Pass-through deduction favors wealthy business owners
...
- Those who can afford lawyers escape scrutiny
...
- Political consequences ignored until too late
...
- Competition eroded before regulators acted

## Political Causes

### Money in Politics

Economic power translates directly to political power:

**Campaign Contributions**

| Source | Impact |
|--------|--------|
| Corporate PACs | $500+ million per cycle |
| Super PACs | Unlimited spending post-Citizens United |
| Dark money | Billions in undisclosed spending |
...
- Regulations shaped to benefit regulated industries
...
- Underfunding makes agencies dependent on industry cooperation

**Examples**

| Agency | Capture Evidence |
|--------|------------------|
| SEC | Light touch with Wall Street; revolving door to firms |
| FCC | Serves telecom industry; opposes competition |
| Banking regulators | Failed to prevent 2008 crisis; weak post-crisis enforcement |
| FDA | Accelerated approvals benefit pharma at expense of safety |
| FAA | Delegated oversight to Boeing before 737 MAX crashes |
...
- "Job creators" framing obscured exploitation
...
- Individualized "responsibility" emphasized
...
- Illusion of prosperity maintained
...
1. **Wealth concentration** provides resources for political influence
2. **Political influence** produces tax cuts, deregulation, weak antitrust
3. **Favorable policies** accelerate wealth concentration
4. **More concentrated wealth** means more political influence
5. **Cycle repeats and intensifies**

### Cross-Cutting Dynamics

| Cause 1 | Cause 2 | Interaction |
|---------|---------|-------------|
| Financialization | Tax policy | Capital gains preference incentivizes financial speculation |
| Technology | Labor markets | Automation + weak unions = worker powerlessness |
| Globalization | Tax policy | Corporate tax competition + mobility = race to bottom |
| Ideology | Regulatory capture | Free market beliefs justify light-touch regulation |
| Money in politics | Antitrust | Campaign contributions from monopolies block enforcement |
| Media | Ideology | Business media normalizes inequality |

### Breaking the Cycle

The reinforcing nature of these causes means:

1. **Partial reforms often reversed**: Without addressing underlying power imbalances, gains can be undone

2. **Multiple interventions needed**: Single policy changes insufficient against systemic dynamics

3. **Political reform foundational**: Economic reform requires democratic reform to be sustainable

4. **Crisis may be necessary**: Entrenched systems often change only under extreme pressure

5. **Coalition building essential**: Counter-power must be built to overcome organized opposition

## Why This Matters for Reform

Understanding root causes suggests reform priorities:

| Root Cause | Reform Priority |
|------------|-----------------|
| Declining worker power | Strengthen labor law; sectoral bargaining |
| Tax policy choices | Progressive tax reform; enforcement |
| Antitrust failure | Reinvigorate competition policy |
| Financialization | Financial sector regulation; transaction taxes |
| Money in politics | Campaign finance reform (political topic) |
| Globalization asymmetry | Labor standards in trade; industrial policy |
| Regulatory capture | Agency independence; revolving door limits |
| Ideological shift | Narrative change; economics reform |

The interconnected nature of causes means comprehensive reform is needed, but political feasibility requires sequencing that builds power for further reform.
