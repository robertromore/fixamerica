# Reform Solutions for Financial Regulation

## Overview

Effective financial reform requires addressing both the immediate symptoms of regulatory failure and the underlying dynamics that produce capture and instability. This chapter presents a comprehensive reform agenda, from structural changes to targeted interventions, drawing on evidence from the pre-deregulation era, international examples, and academic research.

## Structural Reform

### Restore Glass-Steagall Separation
...
- Prohibit affiliation between commercial banks and investment banks
...
**The Problem:**
Fragmented regulation enables regulatory arbitrage and creates gaps in oversight.

**Options:**

| Model | Description | Example |
|-------|-------------|---------|
| Single regulator | One agency for all financial regulation | UK (pre-2013) |
| Twin peaks | Separate prudential and conduct regulators | Australia |
...
- FSOC for macro-prudential coordination
...
- Mandate servicer duty to modify distressed loans
...
- Revenue diversification for USPS

### Fiduciary Duty for All Advice
...
- Strengthen enforcement and private right of action

## Derivatives and Shadow Banking

### Close the Derivatives Loopholes
...
- Position limits on speculative derivatives
- Transaction tax on derivative trades (see below)
...
- Private credit fund disclosure and stress testing
- FSOC designation authority for nonbank SIFIs (restore)
...
- Longer statutes of limitation for financial fraud
- Revive Yates Memo requiring individual focus
...
- Cover both individual and institution-wide failures

### Strengthen SEC and CFTC

**Current Resource Gap:**

| Agency | Budget Request | Industry Compliance Spending |
|--------|---------------|------------------------------|
| SEC | $2.4 billion | $40+ billion industry-wide |
...
- Competitive pay to reduce talent drain

## Credit Rating Agency Reform

### The Problem

Rating agencies are paid by issuers they rate, creating inherent conflicts.

### Solutions

| Approach | Description | Pros | Cons |
|----------|-------------|------|------|
| Investor-pays model | Investors pay for ratings | Aligns incentives | Free-rider problem |
| Public utility | Government or quasi-public raters | Eliminates conflict | Political influence |
| Random assignment | Randomly assign among approved raters | Reduces shopping | May reduce quality |
...
- Liability for grossly negligent ratings
...
- Consumer protection rules for retail crypto
- Prohibition on bank investments in volatile crypto
...
- State coordination for lending fintech

## Private Equity and Hedge Fund Oversight
...
| Transaction Type | Proposed Rate | Revenue Estimate |
|------------------|---------------|------------------|
| Stock trades | 0.1% | $50-100 billion/year |
| Bond trades | 0.01% | $20-40 billion/year |
| Derivatives | 0.01% of notional | $30-60 billion/year |

### Precedents

- UK stamp duty: 0.5% on stocks
- EU FTT proposals: 0.1% stocks, 0.01% derivatives
- Pre-1966 U.S. had transaction taxes

## Bank Merger Reform

### The Problem

Decades of consolidation have reduced competition and created TBTF institutions.

### Implementation

- Presumptive denial for mergers creating banks over $100 billion
- Enhanced community benefit requirements
- Extended public comment periods
- Post-merger monitoring and divestitures if conditions not met
- Climate risk assessment in merger review
...
- Regular testing of resolution procedures
...
## Summary: Reform Priorities

### Tier 1: Structural (Long-term)

1. Restore Glass-Steagall separation
2. Break up too-big-to-fail institutions
3. Unify regulatory structure

### Tier 2: Immediate (Regulatory)

1. Strengthen CFPB enforcement
2. Rate cap on predatory lending
3. Regulate shadow banking
4. Credit rating agency reform
5. Enhanced derivatives oversight

### Tier 3: Accountability

1. Criminal prosecution priority
2. Compensation clawbacks
3. Regulatory resource increase
4. Financial transaction tax

### Tier 4: Emerging Issues

1. Cryptocurrency framework
2. Climate risk integration
3. Private credit oversight
4. AI in lending standards

## Conclusion

Comprehensive financial reform is achievable but requires sustained political will to overcome industry opposition. The evidence is clear: well-regulated financial systems are more stable, more equitable, and ultimately more productive than those captured by the industry they are meant to oversee.
